...
Gem::Specification.new do |s|
  s.name        = "unofficial_freee_sdk"
  s.version     = UnofficialFreeeSdk::VERSION
  s.platform    = Gem::Platform::RUBY
  s.authors     = ["ryo-hashimoto"]
  s.email       = ["ryo.hashimoto.2525@gmail.com"]
  s.homepage    = "https://openapi-generator.tech"
  s.summary     = "freee API Ruby Gem"
  s.description = "unofficial freee sdk for ruby"
  s.license     = "Unlicense"
