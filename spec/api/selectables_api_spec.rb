...
# Unit tests for UnofficialFreeeSdk::SelectablesApi
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'SelectablesApi' do
  before do
  ...
  describe 'test an instance of SelectablesApi' do
    it 'should create an instance of SelectablesApi' do
      expect(@api_instance).to be_instance_of(UnofficialFreeeSdk::SelectablesApi)
    end
  end

  # unit tests for get_forms_selectables
  # フォーム用選択項目情報の取得
  ...
  describe 'get_forms_selectables test' do
    it 'should work' do
