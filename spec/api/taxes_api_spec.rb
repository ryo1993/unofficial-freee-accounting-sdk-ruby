...
# Unit tests for UnofficialFreeeSdk::TaxesApi
...
describe 'TaxesApi' do
  ...
  describe 'test an instance of TaxesApi' do
    it 'should create an instance of TaxesApi' do
      expect(@api_instance).to be_instance_of(UnofficialFreeeSdk::TaxesApi)
    end
  end

  # unit tests for get_tax_code
  # 税区分コードの取得
  #  &lt;h2 id&#x3D;\&quot;\&quot;&gt;概要&lt;/h2&gt;  &lt;p&gt;税区分コードを取得する&lt;/p&gt;
  # @param code 税区分コード
  # @param [Hash] opts the optional parameters
  # @return [TaxResponse]
  describe 'get_tax_code test' do
    it 'should work' do
  ...
  # unit tests for get_taxes_companies
  # 税区分コード詳細一覧の取得
  # @param company_id 事業所ID
  # @param [Hash] opts the optional parameters
  # @return [InlineResponse20011]
  describe 'get_taxes_companies test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
