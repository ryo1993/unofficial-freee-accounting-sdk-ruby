...
# Unit tests for UnofficialFreeeSdk::WalletTxnsApi
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'WalletTxnsApi' do
  before do
  ...
  describe 'test an instance of WalletTxnsApi' do
    it 'should create an instance of WalletTxnsApi' do
      expect(@api_instance).to be_instance_of(UnofficialFreeeSdk::WalletTxnsApi)
    end
  end

  # unit tests for create_wallet_txn
  # 明細の作成
  ...
  describe 'create_wallet_txn test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for destroy_wallet_txn
  # 明細の削除
  ...
  # @param [Hash] opts the optional parameters
  # @return [nil]
  describe 'destroy_wallet_txn test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for get_wallet_txn
  # 明細の取得
  ...
  # @param [Hash] opts the optional parameters
  # @return [WalletTxnResponse]
  describe 'get_wallet_txn test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for get_wallet_txns
  # 明細一覧の取得
  ...
  describe 'get_wallet_txns test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
