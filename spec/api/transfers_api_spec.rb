...
# Unit tests for UnofficialFreeeSdk::TransfersApi
...
describe 'TransfersApi' do
  ...
  describe 'test an instance of TransfersApi' do
    it 'should create an instance of TransfersApi' do
      expect(@api_instance).to be_instance_of(UnofficialFreeeSdk::TransfersApi)
    end
  end

  # unit tests for create_transfer
  # 取引（振替）の作成
  ...
  describe 'create_transfer test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for destroy_transfer
  # 取引（振替）の削除する
  ...
  # @param [Hash] opts the optional parameters
  # @return [nil]
  describe 'destroy_transfer test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
  ...
  # unit tests for update_transfer
  # 取引（振替）の更新
  ...
  # @param id 取引(振替)ID
  # @param transfer_params 取引（振替）の更新
  # @param [Hash] opts the optional parameters
  # @return [TransferResponse]
  describe 'update_transfer test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
