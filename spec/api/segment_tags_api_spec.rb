...
# Unit tests for UnofficialFreeeSdk::SegmentTagsApi
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'SegmentTagsApi' do
  before do
  ...
  describe 'test an instance of SegmentTagsApi' do
    it 'should create an instance of SegmentTagsApi' do
      expect(@api_instance).to be_instance_of(UnofficialFreeeSdk::SegmentTagsApi)
    end
  end

  # unit tests for create_segment_tag
  # セグメントの作成
  ...
  # @param segment_id セグメントID
  # @param segment_tag_params セグメントタグの作成
  # @param [Hash] opts the optional parameters
  # @return [SegmentTagResponse]
  describe 'create_segment_tag test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for destroy_segments_tag
  # セグメントタグの削除
  ...
  # @param [Hash] opts the optional parameters
  # @return [nil]
  describe 'destroy_segments_tag test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
  ...
  # unit tests for update_segment_tag
  # セグメントタグの更新
  ...
  # @param [Hash] opts the optional parameters
  # @return [SegmentTagResponse]
  describe 'update_segment_tag test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
