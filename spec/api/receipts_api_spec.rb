...
# Unit tests for UnofficialFreeeSdk::ReceiptsApi
...
describe 'ReceiptsApi' do
  ...
  describe 'test an instance of ReceiptsApi' do
    it 'should create an instance of ReceiptsApi' do
      expect(@api_instance).to be_instance_of(UnofficialFreeeSdk::ReceiptsApi)
    end
  end
  ...
  # unit tests for destroy_receipt
  ...
  # @param [Hash] opts the optional parameters
  # @return [nil]
  describe 'destroy_receipt test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
  ...
  # @param company_id 事業所ID
  # @param start_date アップロード日 (yyyy-mm-dd)
  # @param end_date アップロード日 (yyyy-mm-dd)
  # @param [Hash] opts the optional parameters
  ...
  # @param id 証憑ID
  # @param receipt_update_params 経費申請の更新
  # @param [Hash] opts the optional parameters
  # @return [ReceiptResponse]
