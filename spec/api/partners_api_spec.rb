...
# Unit tests for UnofficialFreeeSdk::PartnersApi
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'PartnersApi' do
  before do
  ...
  describe 'test an instance of PartnersApi' do
    it 'should create an instance of PartnersApi' do
      expect(@api_instance).to be_instance_of(UnofficialFreeeSdk::PartnersApi)
    end
  end

  # unit tests for create_partner
  # 取引先の作成
  ...
  # @param partner_create_params 取引先の作成
  # @param [Hash] opts the optional parameters
  # @return [PartnerResponse]
  describe 'create_partner test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for destroy_partner
  # 取引先の削除
  ...
  # @param [Hash] opts the optional parameters
  # @return [nil]
  describe 'destroy_partner test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for get_partner
  # 取引先の取得
  ...
  # unit tests for update_partner
  # 取引先の更新
  #  &lt;h2 id&#x3D;\&quot;\&quot;&gt;概要&lt;/h2&gt;  &lt;p&gt;指定した取引先の情報を更新する&lt;/p&gt; &lt;ul&gt; &lt;li&gt;codeを指定、更新することはできません。&lt;/li&gt;&lt;/ul&gt;
  # @param id 取引先ID
  # @param partner_update_params 取引先の更新
  # @param [Hash] opts the optional parameters
  # @return [PartnerResponse]
  describe 'update_partner test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for update_partner_by_code
  # 取引先の更新
  ...
  # @param [Hash] opts the optional parameters
  # @return [PartnerResponse]
  describe 'update_partner_by_code test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
