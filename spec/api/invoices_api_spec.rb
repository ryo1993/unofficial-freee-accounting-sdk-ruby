...
# Unit tests for UnofficialFreeeSdk::InvoicesApi
...
describe 'InvoicesApi' do
  ...
  describe 'test an instance of InvoicesApi' do
    it 'should create an instance of InvoicesApi' do
      expect(@api_instance).to be_instance_of(UnofficialFreeeSdk::InvoicesApi)
    end
  end
  ...
  # unit tests for destroy_invoice
  # 請求書の削除
  ...
  # @param [Hash] opts the optional parameters
  # @return [nil]
  describe 'destroy_invoice test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
