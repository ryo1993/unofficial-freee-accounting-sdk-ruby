...
# Unit tests for UnofficialFreeeSdk::ExpenseApplicationLineTemplatesApi
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'ExpenseApplicationLineTemplatesApi' do
  before do
  ...
  describe 'test an instance of ExpenseApplicationLineTemplatesApi' do
    it 'should create an instance of ExpenseApplicationLineTemplatesApi' do
      expect(@api_instance).to be_instance_of(UnofficialFreeeSdk::ExpenseApplicationLineTemplatesApi)
    end
  end

  # unit tests for create_expense_application_line_template
  # 経費科目の作成
  # @param expense_application_line_template_params 経費科目の作成
  # @param [Hash] opts the optional parameters
  # @return [ExpenseApplicationLineTemplateResponse]
  describe 'create_expense_application_line_template test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for destroy_expense_application_line_template
  # 経費科目の削除
  # @param id 経費科目ID
  # @param company_id 事業所ID
  # @param [Hash] opts the optional parameters
  # @return [nil]
  describe 'destroy_expense_application_line_template test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for get_expense_application_line_template
  # 経費科目の取得
  # @param id 経費科目ID
  # @param company_id 事業所ID
  # @param [Hash] opts the optional parameters
  # @return [ExpenseApplicationLineTemplateResponse]
  describe 'get_expense_application_line_template test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for get_expense_application_line_templates
  # 経費科目一覧の取得
  ...
  describe 'get_expense_application_line_templates test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for update_expense_application_line_template
  # 経費科目の更新
  # @param id 経費科目ID
  # @param expense_application_line_template_params 経費科目の更新
  # @param [Hash] opts the optional parameters
  # @return [ExpenseApplicationLineTemplateResponse]
  describe 'update_expense_application_line_template test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
