...
# Unit tests for UnofficialFreeeSdk::UsersApi
...
describe 'UsersApi' do
  ...
  describe 'test an instance of UsersApi' do
    it 'should create an instance of UsersApi' do
      expect(@api_instance).to be_instance_of(UnofficialFreeeSdk::UsersApi)
    end
  end
  ...
  # unit tests for get_users_capabilities
  # ログインユーザの権限の取得
  #  &lt;h2 id&#x3D;\&quot;\&quot;&gt;概要&lt;/h2&gt;  &lt;p&gt;ユーザの権限情報を取得する&lt;/p&gt;
  # @param company_id 事業所ID
  # @param [Hash] opts the optional parameters
  # @return [InlineResponse2008]
  describe 'get_users_capabilities test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for get_users_me
  # ログインユーザ情報の取得
  #  &lt;h2 id&#x3D;\&quot;\&quot;&gt;概要&lt;/h2&gt;  &lt;p&gt;ユーザの情報を取得する&lt;/p&gt;
  # @param [Hash] opts the optional parameters
  # @option opts [Boolean] :companies 取得情報にユーザが所属する事業所一覧を含める
  # @return [MeResponse]
  describe 'get_users_me test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
