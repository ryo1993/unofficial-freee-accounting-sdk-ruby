...
# Unit tests for UnofficialFreeeSdk::ItemsApi
...
describe 'ItemsApi' do
  ...
  describe 'test an instance of ItemsApi' do
    it 'should create an instance of ItemsApi' do
      expect(@api_instance).to be_instance_of(UnofficialFreeeSdk::ItemsApi)
    end
  end
