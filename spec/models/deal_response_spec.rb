...
# Unit tests for UnofficialFreeeSdk::DealResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'DealResponse' do
  before do
    # run before each test
    @instance = UnofficialFreeeSdk::DealResponse.new
  end
  ...
  describe 'test an instance of DealResponse' do
    it 'should create an instance of DealResponse' do
      expect(@instance).to be_instance_of(UnofficialFreeeSdk::DealResponse)
    end
  end
