...
# Unit tests for UnofficialFreeeSdk::DealResponseDealRenews
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'DealResponseDealRenews' do
  before do
    # run before each test
    @instance = UnofficialFreeeSdk::DealResponseDealRenews.new
  end
  ...
  describe 'test an instance of DealResponseDealRenews' do
    it 'should create an instance of DealResponseDealRenews' do
      expect(@instance).to be_instance_of(UnofficialFreeeSdk::DealResponseDealRenews)
    end
  end
  ...
  describe 'test attribute "renew_target_id"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "renew_target_type"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["detail", "accrual", "renew"])
      # validator.allowable_values.each do |value|
      #   expect { @instance.renew_target_type = value }.not_to raise_error
      # end
    end
  end
