...
# Unit tests for UnofficialFreeeSdk::InlineResponse2007
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'InlineResponse2007' do
  before do
    # run before each test
    @instance = UnofficialFreeeSdk::InlineResponse2007.new
  end
  ...
  describe 'test an instance of InlineResponse2007' do
    it 'should create an instance of InlineResponse2007' do
      expect(@instance).to be_instance_of(UnofficialFreeeSdk::InlineResponse2007)
    end
  end
