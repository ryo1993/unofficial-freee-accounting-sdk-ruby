...
# Unit tests for UnofficialFreeeSdk::TagResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'TagResponse' do
  before do
    # run before each test
    @instance = UnofficialFreeeSdk::TagResponse.new
  end
  ...
  describe 'test an instance of TagResponse' do
    it 'should create an instance of TagResponse' do
      expect(@instance).to be_instance_of(UnofficialFreeeSdk::TagResponse)
    end
  end
