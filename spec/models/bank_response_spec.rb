...
# Unit tests for UnofficialFreeeSdk::BankResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'BankResponse' do
  before do
    # run before each test
    @instance = UnofficialFreeeSdk::BankResponse.new
  end
  ...
  describe 'test an instance of BankResponse' do
    it 'should create an instance of BankResponse' do
      expect(@instance).to be_instance_of(UnofficialFreeeSdk::BankResponse)
    end
  end
