...
# Unit tests for UnofficialFreeeSdk::TransferResponseTransfer
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'TransferResponseTransfer' do
  before do
    # run before each test
    @instance = UnofficialFreeeSdk::TransferResponseTransfer.new
  end
  ...
  describe 'test an instance of TransferResponseTransfer' do
    it 'should create an instance of TransferResponseTransfer' do
      expect(@instance).to be_instance_of(UnofficialFreeeSdk::TransferResponseTransfer)
    end
  end
  ...
  describe 'test attribute "from_walletable_type"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["bank_account", "wallet", "credit_card"])
      # validator.allowable_values.each do |value|
      #   expect { @instance.from_walletable_type = value }.not_to raise_error
      # end
    end
  end

  describe 'test attribute "from_walletable_id"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "to_walletable_type"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["bank_account", "wallet", "credit_card"])
      # validator.allowable_values.each do |value|
      #   expect { @instance.to_walletable_type = value }.not_to raise_error
      # end
    end
  end

  describe 'test attribute "to_walletable_id"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
