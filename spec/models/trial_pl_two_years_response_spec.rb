...
# Unit tests for UnofficialFreeeSdk::TrialPlTwoYearsResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'TrialPlTwoYearsResponse' do
  before do
    # run before each test
    @instance = UnofficialFreeeSdk::TrialPlTwoYearsResponse.new
  end
  ...
  describe 'test an instance of TrialPlTwoYearsResponse' do
    it 'should create an instance of TrialPlTwoYearsResponse' do
      expect(@instance).to be_instance_of(UnofficialFreeeSdk::TrialPlTwoYearsResponse)
    end
  end
  describe 'test attribute "trial_pl_two_years"' do
    it 'should work' do
