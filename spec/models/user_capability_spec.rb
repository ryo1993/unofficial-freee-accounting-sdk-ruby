...
# Unit tests for UnofficialFreeeSdk::UserCapability
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'UserCapability' do
  before do
    # run before each test
    @instance = UnofficialFreeeSdk::UserCapability.new
  end
  ...
  describe 'test an instance of UserCapability' do
    it 'should create an instance of UserCapability' do
      expect(@instance).to be_instance_of(UnofficialFreeeSdk::UserCapability)
    end
  end
  ...
  describe 'test attribute "destroy"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
