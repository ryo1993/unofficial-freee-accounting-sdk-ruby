...
# Unit tests for UnofficialFreeeSdk::TrialBsThreeYearsResponseTrialBsThreeYearsPartners
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'TrialBsThreeYearsResponseTrialBsThreeYearsPartners' do
  before do
    # run before each test
    @instance = UnofficialFreeeSdk::TrialBsThreeYearsResponseTrialBsThreeYearsPartners.new
  end
  ...
  describe 'test an instance of TrialBsThreeYearsResponseTrialBsThreeYearsPartners' do
    it 'should create an instance of TrialBsThreeYearsResponseTrialBsThreeYearsPartners' do
      expect(@instance).to be_instance_of(UnofficialFreeeSdk::TrialBsThreeYearsResponseTrialBsThreeYearsPartners)
    end
  end
