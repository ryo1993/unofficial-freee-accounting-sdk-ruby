...
# Unit tests for UnofficialFreeeSdk::ServiceUnavailableError
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'ServiceUnavailableError' do
  before do
    # run before each test
    @instance = UnofficialFreeeSdk::ServiceUnavailableError.new
  end
  ...
  describe 'test an instance of ServiceUnavailableError' do
    it 'should create an instance of ServiceUnavailableError' do
      expect(@instance).to be_instance_of(UnofficialFreeeSdk::ServiceUnavailableError)
    end
  end
