...
# Unit tests for UnofficialFreeeSdk::ExpenseApplicationLineTemplateParams
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'ExpenseApplicationLineTemplateParams' do
  before do
    # run before each test
    @instance = UnofficialFreeeSdk::ExpenseApplicationLineTemplateParams.new
  end
  ...
  describe 'test an instance of ExpenseApplicationLineTemplateParams' do
    it 'should create an instance of ExpenseApplicationLineTemplateParams' do
      expect(@instance).to be_instance_of(UnofficialFreeeSdk::ExpenseApplicationLineTemplateParams)
    end
  end
  ...
  describe 'test attribute "account_items_id"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
