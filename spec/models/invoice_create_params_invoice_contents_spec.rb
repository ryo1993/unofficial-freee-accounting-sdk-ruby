...
# Unit tests for UnofficialFreeeSdk::InvoiceCreateParamsInvoiceContents
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'InvoiceCreateParamsInvoiceContents' do
  before do
    # run before each test
    @instance = UnofficialFreeeSdk::InvoiceCreateParamsInvoiceContents.new
  end
  ...
  describe 'test an instance of InvoiceCreateParamsInvoiceContents' do
    it 'should create an instance of InvoiceCreateParamsInvoiceContents' do
      expect(@instance).to be_instance_of(UnofficialFreeeSdk::InvoiceCreateParamsInvoiceContents)
    end
  end
