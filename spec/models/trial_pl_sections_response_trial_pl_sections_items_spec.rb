...
# Unit tests for UnofficialFreeeSdk::TrialPlSectionsResponseTrialPlSectionsItems
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'TrialPlSectionsResponseTrialPlSectionsItems' do
  before do
    # run before each test
    @instance = UnofficialFreeeSdk::TrialPlSectionsResponseTrialPlSectionsItems.new
  end
  ...
  describe 'test an instance of TrialPlSectionsResponseTrialPlSectionsItems' do
    it 'should create an instance of TrialPlSectionsResponseTrialPlSectionsItems' do
      expect(@instance).to be_instance_of(UnofficialFreeeSdk::TrialPlSectionsResponseTrialPlSectionsItems)
    end
  end
