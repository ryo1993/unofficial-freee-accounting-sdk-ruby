...
# Unit tests for UnofficialFreeeSdk::InvoiceResponseInvoiceTotalAmountPerVatRate
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'InvoiceResponseInvoiceTotalAmountPerVatRate' do
  before do
    # run before each test
    @instance = UnofficialFreeeSdk::InvoiceResponseInvoiceTotalAmountPerVatRate.new
  end
  ...
  describe 'test an instance of InvoiceResponseInvoiceTotalAmountPerVatRate' do
    it 'should create an instance of InvoiceResponseInvoiceTotalAmountPerVatRate' do
      expect(@instance).to be_instance_of(UnofficialFreeeSdk::InvoiceResponseInvoiceTotalAmountPerVatRate)
    end
  end
  describe 'test attribute "vat_5"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "vat_8"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "reduced_vat_8"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "vat_10"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
