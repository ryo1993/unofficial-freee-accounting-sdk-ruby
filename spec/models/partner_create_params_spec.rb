...
# Unit tests for UnofficialFreeeSdk::PartnerCreateParams
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'PartnerCreateParams' do
  before do
    # run before each test
    @instance = UnofficialFreeeSdk::PartnerCreateParams.new
  end
  ...
  describe 'test an instance of PartnerCreateParams' do
    it 'should create an instance of PartnerCreateParams' do
      expect(@instance).to be_instance_of(UnofficialFreeeSdk::PartnerCreateParams)
    end
  end
  ...
  describe 'test attribute "shortcut1"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "shortcut2"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
  ...
  describe 'test attribute "partner_doc_setting_attributes"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "partner_bank_account_attributes"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
