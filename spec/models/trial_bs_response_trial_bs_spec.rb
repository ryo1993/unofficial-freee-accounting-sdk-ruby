...
# Unit tests for UnofficialFreeeSdk::TrialBsResponseTrialBs
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'TrialBsResponseTrialBs' do
  before do
    # run before each test
    @instance = UnofficialFreeeSdk::TrialBsResponseTrialBs.new
  end
  ...
  describe 'test an instance of TrialBsResponseTrialBs' do
    it 'should create an instance of TrialBsResponseTrialBs' do
      expect(@instance).to be_instance_of(UnofficialFreeeSdk::TrialBsResponseTrialBs)
    end
  end
