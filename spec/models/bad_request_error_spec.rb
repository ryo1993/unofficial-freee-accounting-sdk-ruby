...
# Unit tests for UnofficialFreeeSdk::BadRequestError
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'BadRequestError' do
  before do
    # run before each test
    @instance = UnofficialFreeeSdk::BadRequestError.new
  end
  ...
  describe 'test an instance of BadRequestError' do
    it 'should create an instance of BadRequestError' do
      expect(@instance).to be_instance_of(UnofficialFreeeSdk::BadRequestError)
    end
  end
