...
# Unit tests for UnofficialFreeeSdk::TransferResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'TransferResponse' do
  before do
    # run before each test
    @instance = UnofficialFreeeSdk::TransferResponse.new
  end
  ...
  describe 'test an instance of TransferResponse' do
    it 'should create an instance of TransferResponse' do
      expect(@instance).to be_instance_of(UnofficialFreeeSdk::TransferResponse)
    end
  end
