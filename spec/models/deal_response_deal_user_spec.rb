...
# Unit tests for UnofficialFreeeSdk::DealResponseDealUser
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'DealResponseDealUser' do
  before do
    # run before each test
    @instance = UnofficialFreeeSdk::DealResponseDealUser.new
  end
  ...
  describe 'test an instance of DealResponseDealUser' do
    it 'should create an instance of DealResponseDealUser' do
      expect(@instance).to be_instance_of(UnofficialFreeeSdk::DealResponseDealUser)
    end
  end
