...
# Unit tests for UnofficialFreeeSdk::InlineResponse2002
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'InlineResponse2002' do
  before do
    # run before each test
    @instance = UnofficialFreeeSdk::InlineResponse2002.new
  end
  ...
  describe 'test an instance of InlineResponse2002' do
    it 'should create an instance of InlineResponse2002' do
      expect(@instance).to be_instance_of(UnofficialFreeeSdk::InlineResponse2002)
    end
  end
