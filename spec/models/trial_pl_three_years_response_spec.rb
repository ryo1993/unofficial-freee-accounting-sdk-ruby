...
# Unit tests for UnofficialFreeeSdk::TrialPlThreeYearsResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'TrialPlThreeYearsResponse' do
  before do
    # run before each test
    @instance = UnofficialFreeeSdk::TrialPlThreeYearsResponse.new
  end
  ...
  describe 'test an instance of TrialPlThreeYearsResponse' do
    it 'should create an instance of TrialPlThreeYearsResponse' do
      expect(@instance).to be_instance_of(UnofficialFreeeSdk::TrialPlThreeYearsResponse)
    end
  end
  describe 'test attribute "trial_pl_three_years"' do
    it 'should work' do
