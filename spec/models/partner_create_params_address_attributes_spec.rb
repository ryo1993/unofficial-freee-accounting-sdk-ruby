...
# Unit tests for UnofficialFreeeSdk::PartnerCreateParamsAddressAttributes
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'PartnerCreateParamsAddressAttributes' do
  before do
    # run before each test
    @instance = UnofficialFreeeSdk::PartnerCreateParamsAddressAttributes.new
  end
  ...
  describe 'test an instance of PartnerCreateParamsAddressAttributes' do
    it 'should create an instance of PartnerCreateParamsAddressAttributes' do
      expect(@instance).to be_instance_of(UnofficialFreeeSdk::PartnerCreateParamsAddressAttributes)
    end
  end
