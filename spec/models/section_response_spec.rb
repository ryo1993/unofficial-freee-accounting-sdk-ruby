...
# Unit tests for UnofficialFreeeSdk::SectionResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'SectionResponse' do
  before do
    # run before each test
    @instance = UnofficialFreeeSdk::SectionResponse.new
  end
  ...
  describe 'test an instance of SectionResponse' do
    it 'should create an instance of SectionResponse' do
      expect(@instance).to be_instance_of(UnofficialFreeeSdk::SectionResponse)
    end
  end
