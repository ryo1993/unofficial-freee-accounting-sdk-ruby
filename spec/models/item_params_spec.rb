...
# Unit tests for UnofficialFreeeSdk::ItemParams
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'ItemParams' do
  before do
    # run before each test
    @instance = UnofficialFreeeSdk::ItemParams.new
  end
  ...
  describe 'test an instance of ItemParams' do
    it 'should create an instance of ItemParams' do
      expect(@instance).to be_instance_of(UnofficialFreeeSdk::ItemParams)
    end
  end
