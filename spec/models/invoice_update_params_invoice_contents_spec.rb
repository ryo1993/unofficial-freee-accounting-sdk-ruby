...
# Unit tests for UnofficialFreeeSdk::InvoiceUpdateParamsInvoiceContents
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'InvoiceUpdateParamsInvoiceContents' do
  before do
    # run before each test
    @instance = UnofficialFreeeSdk::InvoiceUpdateParamsInvoiceContents.new
  end
  ...
  describe 'test an instance of InvoiceUpdateParamsInvoiceContents' do
    it 'should create an instance of InvoiceUpdateParamsInvoiceContents' do
      expect(@instance).to be_instance_of(UnofficialFreeeSdk::InvoiceUpdateParamsInvoiceContents)
    end
  end
