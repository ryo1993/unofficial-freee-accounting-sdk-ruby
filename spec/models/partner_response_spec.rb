...
# Unit tests for UnofficialFreeeSdk::PartnerResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'PartnerResponse' do
  before do
    # run before each test
    @instance = UnofficialFreeeSdk::PartnerResponse.new
  end
  ...
  describe 'test an instance of PartnerResponse' do
    it 'should create an instance of PartnerResponse' do
      expect(@instance).to be_instance_of(UnofficialFreeeSdk::PartnerResponse)
    end
  end
