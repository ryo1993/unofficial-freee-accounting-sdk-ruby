...
# Unit tests for UnofficialFreeeSdk::ManualJournalUpdateParams
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'ManualJournalUpdateParams' do
  before do
    # run before each test
    @instance = UnofficialFreeeSdk::ManualJournalUpdateParams.new
  end
  ...
  describe 'test an instance of ManualJournalUpdateParams' do
    it 'should create an instance of ManualJournalUpdateParams' do
      expect(@instance).to be_instance_of(UnofficialFreeeSdk::ManualJournalUpdateParams)
    end
  end
