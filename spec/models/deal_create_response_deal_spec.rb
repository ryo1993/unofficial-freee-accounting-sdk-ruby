...
# Unit tests for UnofficialFreeeSdk::DealCreateResponseDeal
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'DealCreateResponseDeal' do
  before do
    # run before each test
    @instance = UnofficialFreeeSdk::DealCreateResponseDeal.new
  end
  ...
  describe 'test an instance of DealCreateResponseDeal' do
    it 'should create an instance of DealCreateResponseDeal' do
      expect(@instance).to be_instance_of(UnofficialFreeeSdk::DealCreateResponseDeal)
    end
  end
