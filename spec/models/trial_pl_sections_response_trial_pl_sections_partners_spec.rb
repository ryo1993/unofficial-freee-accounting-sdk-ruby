...
# Unit tests for UnofficialFreeeSdk::TrialPlSectionsResponseTrialPlSectionsPartners
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'TrialPlSectionsResponseTrialPlSectionsPartners' do
  before do
    # run before each test
    @instance = UnofficialFreeeSdk::TrialPlSectionsResponseTrialPlSectionsPartners.new
  end
  ...
  describe 'test an instance of TrialPlSectionsResponseTrialPlSectionsPartners' do
    it 'should create an instance of TrialPlSectionsResponseTrialPlSectionsPartners' do
      expect(@instance).to be_instance_of(UnofficialFreeeSdk::TrialPlSectionsResponseTrialPlSectionsPartners)
    end
  end
