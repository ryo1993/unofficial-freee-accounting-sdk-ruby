...
# Unit tests for UnofficialFreeeSdk::ExpenseApplicationLineTemplateResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'ExpenseApplicationLineTemplateResponse' do
  before do
    # run before each test
    @instance = UnofficialFreeeSdk::ExpenseApplicationLineTemplateResponse.new
  end
  ...
  describe 'test an instance of ExpenseApplicationLineTemplateResponse' do
    it 'should create an instance of ExpenseApplicationLineTemplateResponse' do
      expect(@instance).to be_instance_of(UnofficialFreeeSdk::ExpenseApplicationLineTemplateResponse)
    end
  end
  describe 'test attribute "expense_application_line_template"' do
    it 'should work' do
