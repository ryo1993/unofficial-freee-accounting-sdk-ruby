...
# Unit tests for UnofficialFreeeSdk::TrialBsTwoYearsResponseTrialBsTwoYearsPartners
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'TrialBsTwoYearsResponseTrialBsTwoYearsPartners' do
  before do
    # run before each test
    @instance = UnofficialFreeeSdk::TrialBsTwoYearsResponseTrialBsTwoYearsPartners.new
  end
  ...
  describe 'test an instance of TrialBsTwoYearsResponseTrialBsTwoYearsPartners' do
    it 'should create an instance of TrialBsTwoYearsResponseTrialBsTwoYearsPartners' do
      expect(@instance).to be_instance_of(UnofficialFreeeSdk::TrialBsTwoYearsResponseTrialBsTwoYearsPartners)
    end
  end
