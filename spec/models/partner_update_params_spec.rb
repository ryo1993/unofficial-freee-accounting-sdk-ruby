...
# Unit tests for UnofficialFreeeSdk::PartnerUpdateParams
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'PartnerUpdateParams' do
  before do
    # run before each test
    @instance = UnofficialFreeeSdk::PartnerUpdateParams.new
  end
  ...
  describe 'test an instance of PartnerUpdateParams' do
    it 'should create an instance of PartnerUpdateParams' do
      expect(@instance).to be_instance_of(UnofficialFreeeSdk::PartnerUpdateParams)
    end
  end
