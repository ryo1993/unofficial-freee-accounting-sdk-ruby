...
# Unit tests for UnofficialFreeeSdk::ApprovalRequestResponseApprovalRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'ApprovalRequestResponseApprovalRequest' do
  before do
    # run before each test
    @instance = UnofficialFreeeSdk::ApprovalRequestResponseApprovalRequest.new
  end
  ...
  describe 'test an instance of ApprovalRequestResponseApprovalRequest' do
    it 'should create an instance of ApprovalRequestResponseApprovalRequest' do
      expect(@instance).to be_instance_of(UnofficialFreeeSdk::ApprovalRequestResponseApprovalRequest)
    end
  end
