...
# Unit tests for UnofficialFreeeSdk::CompanyParams
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'CompanyParams' do
  before do
    # run before each test
    @instance = UnofficialFreeeSdk::CompanyParams.new
  end
  ...
  describe 'test an instance of CompanyParams' do
    it 'should create an instance of CompanyParams' do
      expect(@instance).to be_instance_of(UnofficialFreeeSdk::CompanyParams)
    end
  end
  ...
  describe 'test attribute "sales_information_attributes"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
  ...
  describe 'test attribute "head_count"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('Float', [0, 1, 2, 3, 13, 14, 15, 18, 16, 17])
      # validator.allowable_values.each do |value|
      #   expect { @instance.head_count = value }.not_to raise_error
      # end
    end
  end
  ...
  describe 'test attribute "fiscal_years_attributes"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "doc_template"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
