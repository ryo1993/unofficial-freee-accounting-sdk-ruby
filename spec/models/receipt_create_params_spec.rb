...
# Unit tests for UnofficialFreeeSdk::ReceiptCreateParams
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'ReceiptCreateParams' do
  before do
    # run before each test
    @instance = UnofficialFreeeSdk::ReceiptCreateParams.new
  end
  ...
  describe 'test an instance of ReceiptCreateParams' do
    it 'should create an instance of ReceiptCreateParams' do
      expect(@instance).to be_instance_of(UnofficialFreeeSdk::ReceiptCreateParams)
    end
  end
