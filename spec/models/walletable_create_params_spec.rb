...
# Unit tests for UnofficialFreeeSdk::WalletableCreateParams
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'WalletableCreateParams' do
  before do
    # run before each test
    @instance = UnofficialFreeeSdk::WalletableCreateParams.new
  end
  ...
  describe 'test an instance of WalletableCreateParams' do
    it 'should create an instance of WalletableCreateParams' do
      expect(@instance).to be_instance_of(UnofficialFreeeSdk::WalletableCreateParams)
    end
  end
