...
# Unit tests for UnofficialFreeeSdk::FiscalYears
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'FiscalYears' do
  before do
    # run before each test
    @instance = UnofficialFreeeSdk::FiscalYears.new
  end
  ...
  describe 'test an instance of FiscalYears' do
    it 'should create an instance of FiscalYears' do
      expect(@instance).to be_instance_of(UnofficialFreeeSdk::FiscalYears)
    end
  end
