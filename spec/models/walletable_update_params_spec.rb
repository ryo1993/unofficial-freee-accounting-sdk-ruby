...
# Unit tests for UnofficialFreeeSdk::WalletableUpdateParams
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'WalletableUpdateParams' do
  before do
    # run before each test
    @instance = UnofficialFreeeSdk::WalletableUpdateParams.new
  end
  ...
  describe 'test an instance of WalletableUpdateParams' do
    it 'should create an instance of WalletableUpdateParams' do
      expect(@instance).to be_instance_of(UnofficialFreeeSdk::WalletableUpdateParams)
    end
  end
