...
# Unit tests for UnofficialFreeeSdk::TooManyRequestsError
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'TooManyRequestsError' do
  before do
    # run before each test
    @instance = UnofficialFreeeSdk::TooManyRequestsError.new
  end
  ...
  describe 'test an instance of TooManyRequestsError' do
    it 'should create an instance of TooManyRequestsError' do
      expect(@instance).to be_instance_of(UnofficialFreeeSdk::TooManyRequestsError)
    end
  end
