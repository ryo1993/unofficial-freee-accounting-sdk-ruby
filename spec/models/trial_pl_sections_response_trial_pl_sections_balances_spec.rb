...
# Unit tests for UnofficialFreeeSdk::TrialPlSectionsResponseTrialPlSectionsBalances
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'TrialPlSectionsResponseTrialPlSectionsBalances' do
  before do
    # run before each test
    @instance = UnofficialFreeeSdk::TrialPlSectionsResponseTrialPlSectionsBalances.new
  end
  ...
  describe 'test an instance of TrialPlSectionsResponseTrialPlSectionsBalances' do
    it 'should create an instance of TrialPlSectionsResponseTrialPlSectionsBalances' do
      expect(@instance).to be_instance_of(UnofficialFreeeSdk::TrialPlSectionsResponseTrialPlSectionsBalances)
    end
  end
