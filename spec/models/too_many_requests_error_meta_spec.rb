...
# Unit tests for UnofficialFreeeSdk::TooManyRequestsErrorMeta
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'TooManyRequestsErrorMeta' do
  before do
    # run before each test
    @instance = UnofficialFreeeSdk::TooManyRequestsErrorMeta.new
  end
  ...
  describe 'test an instance of TooManyRequestsErrorMeta' do
    it 'should create an instance of TooManyRequestsErrorMeta' do
      expect(@instance).to be_instance_of(UnofficialFreeeSdk::TooManyRequestsErrorMeta)
    end
  end
