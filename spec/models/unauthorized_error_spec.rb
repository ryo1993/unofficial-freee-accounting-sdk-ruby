...
# Unit tests for UnofficialFreeeSdk::UnauthorizedError
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'UnauthorizedError' do
  before do
    # run before each test
    @instance = UnofficialFreeeSdk::UnauthorizedError.new
  end
  ...
  describe 'test an instance of UnauthorizedError' do
    it 'should create an instance of UnauthorizedError' do
      expect(@instance).to be_instance_of(UnofficialFreeeSdk::UnauthorizedError)
    end
  end
