...
# Unit tests for UnofficialFreeeSdk::TrialBsTwoYearsResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'TrialBsTwoYearsResponse' do
  before do
    # run before each test
    @instance = UnofficialFreeeSdk::TrialBsTwoYearsResponse.new
  end
  ...
  describe 'test an instance of TrialBsTwoYearsResponse' do
    it 'should create an instance of TrialBsTwoYearsResponse' do
      expect(@instance).to be_instance_of(UnofficialFreeeSdk::TrialBsTwoYearsResponse)
    end
  end
  describe 'test attribute "trial_bs_two_years"' do
    it 'should work' do
