...
# Unit tests for UnofficialFreeeSdk::DealResponseDeal
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'DealResponseDeal' do
  before do
    # run before each test
    @instance = UnofficialFreeeSdk::DealResponseDeal.new
  end
  ...
  describe 'test an instance of DealResponseDeal' do
    it 'should create an instance of DealResponseDeal' do
      expect(@instance).to be_instance_of(UnofficialFreeeSdk::DealResponseDeal)
    end
  end
  ...
  describe 'test attribute "renews"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
