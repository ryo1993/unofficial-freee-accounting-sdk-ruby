...
# Unit tests for UnofficialFreeeSdk::InlineResponse20012
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'InlineResponse20012' do
  before do
    # run before each test
    @instance = UnofficialFreeeSdk::InlineResponse20012.new
  end
  ...
  describe 'test an instance of InlineResponse20012' do
    it 'should create an instance of InlineResponse20012' do
      expect(@instance).to be_instance_of(UnofficialFreeeSdk::InlineResponse20012)
    end
  end
