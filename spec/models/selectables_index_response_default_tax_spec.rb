...
# Unit tests for UnofficialFreeeSdk::SelectablesIndexResponseDefaultTax
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'SelectablesIndexResponseDefaultTax' do
  before do
    # run before each test
    @instance = UnofficialFreeeSdk::SelectablesIndexResponseDefaultTax.new
  end
  ...
  describe 'test an instance of SelectablesIndexResponseDefaultTax' do
    it 'should create an instance of SelectablesIndexResponseDefaultTax' do
      expect(@instance).to be_instance_of(UnofficialFreeeSdk::SelectablesIndexResponseDefaultTax)
    end
  end
  describe 'test attribute "tax_rate_5"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "tax_rate_8"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
