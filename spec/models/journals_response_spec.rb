...
# Unit tests for UnofficialFreeeSdk::JournalsResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'JournalsResponse' do
  before do
    # run before each test
    @instance = UnofficialFreeeSdk::JournalsResponse.new
  end
  ...
  describe 'test an instance of JournalsResponse' do
    it 'should create an instance of JournalsResponse' do
      expect(@instance).to be_instance_of(UnofficialFreeeSdk::JournalsResponse)
    end
  end
