...
# Unit tests for UnofficialFreeeSdk::CompanyParamsSalesInformationAttributes
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'CompanyParamsSalesInformationAttributes' do
  before do
    # run before each test
    @instance = UnofficialFreeeSdk::CompanyParamsSalesInformationAttributes.new
  end
  ...
  describe 'test an instance of CompanyParamsSalesInformationAttributes' do
    it 'should create an instance of CompanyParamsSalesInformationAttributes' do
      expect(@instance).to be_instance_of(UnofficialFreeeSdk::CompanyParamsSalesInformationAttributes)
    end
  end
