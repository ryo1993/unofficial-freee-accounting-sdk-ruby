...
# Unit tests for UnofficialFreeeSdk::SectionResponseSection
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'SectionResponseSection' do
  before do
    # run before each test
    @instance = UnofficialFreeeSdk::SectionResponseSection.new
  end
  ...
  describe 'test an instance of SectionResponseSection' do
    it 'should create an instance of SectionResponseSection' do
      expect(@instance).to be_instance_of(UnofficialFreeeSdk::SectionResponseSection)
    end
  end
