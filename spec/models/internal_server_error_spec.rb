...
# Unit tests for UnofficialFreeeSdk::InternalServerError
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'InternalServerError' do
  before do
    # run before each test
    @instance = UnofficialFreeeSdk::InternalServerError.new
  end
  ...
  describe 'test an instance of InternalServerError' do
    it 'should create an instance of InternalServerError' do
      expect(@instance).to be_instance_of(UnofficialFreeeSdk::InternalServerError)
    end
  end
