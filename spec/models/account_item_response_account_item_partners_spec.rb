...
# Unit tests for UnofficialFreeeSdk::AccountItemResponseAccountItemPartners
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'AccountItemResponseAccountItemPartners' do
  before do
    # run before each test
    @instance = UnofficialFreeeSdk::AccountItemResponseAccountItemPartners.new
  end
  ...
  describe 'test an instance of AccountItemResponseAccountItemPartners' do
    it 'should create an instance of AccountItemResponseAccountItemPartners' do
      expect(@instance).to be_instance_of(UnofficialFreeeSdk::AccountItemResponseAccountItemPartners)
    end
  end
