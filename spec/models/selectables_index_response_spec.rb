...
# Unit tests for UnofficialFreeeSdk::SelectablesIndexResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'SelectablesIndexResponse' do
  before do
    # run before each test
    @instance = UnofficialFreeeSdk::SelectablesIndexResponse.new
  end
  ...
  describe 'test an instance of SelectablesIndexResponse' do
    it 'should create an instance of SelectablesIndexResponse' do
      expect(@instance).to be_instance_of(UnofficialFreeeSdk::SelectablesIndexResponse)
    end
  end
  describe 'test attribute "account_categories"' do
    it 'should work' do
