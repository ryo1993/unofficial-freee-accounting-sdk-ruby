...
# Unit tests for UnofficialFreeeSdk::TransferParams
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'TransferParams' do
  before do
    # run before each test
    @instance = UnofficialFreeeSdk::TransferParams.new
  end
  ...
  describe 'test an instance of TransferParams' do
    it 'should create an instance of TransferParams' do
      expect(@instance).to be_instance_of(UnofficialFreeeSdk::TransferParams)
    end
  end
