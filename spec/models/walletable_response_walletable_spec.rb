...
# Unit tests for UnofficialFreeeSdk::WalletableResponseWalletable
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'WalletableResponseWalletable' do
  before do
    # run before each test
    @instance = UnofficialFreeeSdk::WalletableResponseWalletable.new
  end
  ...
  describe 'test an instance of WalletableResponseWalletable' do
    it 'should create an instance of WalletableResponseWalletable' do
      expect(@instance).to be_instance_of(UnofficialFreeeSdk::WalletableResponseWalletable)
    end
  end
  ...
  describe 'test attribute "last_balance"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "walletable_balance"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
