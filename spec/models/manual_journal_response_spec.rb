...
# Unit tests for UnofficialFreeeSdk::ManualJournalResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'ManualJournalResponse' do
  before do
    # run before each test
    @instance = UnofficialFreeeSdk::ManualJournalResponse.new
  end
  ...
  describe 'test an instance of ManualJournalResponse' do
    it 'should create an instance of ManualJournalResponse' do
      expect(@instance).to be_instance_of(UnofficialFreeeSdk::ManualJournalResponse)
    end
  end
  describe 'test attribute "manual_journal"' do
    it 'should work' do
