...
# Unit tests for UnofficialFreeeSdk::TrialBsThreeYearsResponseTrialBsThreeYears
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'TrialBsThreeYearsResponseTrialBsThreeYears' do
  before do
    # run before each test
    @instance = UnofficialFreeeSdk::TrialBsThreeYearsResponseTrialBsThreeYears.new
  end
  ...
  describe 'test an instance of TrialBsThreeYearsResponseTrialBsThreeYears' do
    it 'should create an instance of TrialBsThreeYearsResponseTrialBsThreeYears' do
      expect(@instance).to be_instance_of(UnofficialFreeeSdk::TrialBsThreeYearsResponseTrialBsThreeYears)
    end
  end
