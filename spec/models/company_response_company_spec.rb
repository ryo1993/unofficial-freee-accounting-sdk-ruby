...
# Unit tests for UnofficialFreeeSdk::CompanyResponseCompany
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'CompanyResponseCompany' do
  before do
    # run before each test
    @instance = UnofficialFreeeSdk::CompanyResponseCompany.new
  end
  ...
  describe 'test an instance of CompanyResponseCompany' do
    it 'should create an instance of CompanyResponseCompany' do
      expect(@instance).to be_instance_of(UnofficialFreeeSdk::CompanyResponseCompany)
    end
  end
  ...
  describe 'test attribute "tax_at_source_calc_type"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
  ...
  describe 'test attribute "txn_number_format"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["not_used", "digits", "alnum"])
      # validator.allowable_values.each do |value|
      #   expect { @instance.txn_number_format = value }.not_to raise_error
      # end
    end
  end

  describe 'test attribute "default_wallet_account_id"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "private_settlement"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "minus_format"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
  ...
  describe 'test attribute "role"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["admin", "simple_accounting", "self_only", "read_only"])
      # validator.allowable_values.each do |value|
  ...
  describe 'test attribute "street_name1"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "street_name2"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
  ...
  describe 'test attribute "invoice_style"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "amount_fraction"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
  ...
  describe 'test attribute "industry_class"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["", "agriculture_forestry_fisheries_ore", "construction", "manufacturing_processing", "it", "transportation_logistics", "retail_wholesale", "finance_insurance", "real_estate_rental", "profession", "design_production", "food", "lifestyle", "education", "medical_welfare", "other_services", "other"])
      # validator.allowable_values.each do |value|
      #   expect { @instance.industry_class = value }.not_to raise_error
      # end
    end
  end
  ...
  describe 'test attribute "industry_code"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["", "transport_delivery", "delivery", "other_transportation_logistics"])
      # validator.allowable_values.each do |value|
  ...
  describe 'test attribute "workflow_setting"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["enable", "disable"])
      # validator.allowable_values.each do |value|
      #   expect { @instance.workflow_setting = value }.not_to raise_error
      # end
    end
  end

  describe 'test attribute "use_partner_code"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "fiscal_years"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
