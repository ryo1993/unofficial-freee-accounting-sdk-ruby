...
# Unit tests for UnofficialFreeeSdk::PartnerCreateParamsPartnerDocSettingAttributes
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'PartnerCreateParamsPartnerDocSettingAttributes' do
  before do
    # run before each test
    @instance = UnofficialFreeeSdk::PartnerCreateParamsPartnerDocSettingAttributes.new
  end
  ...
  describe 'test an instance of PartnerCreateParamsPartnerDocSettingAttributes' do
    it 'should create an instance of PartnerCreateParamsPartnerDocSettingAttributes' do
      expect(@instance).to be_instance_of(UnofficialFreeeSdk::PartnerCreateParamsPartnerDocSettingAttributes)
    end
  end
  describe 'test attribute "sending_method"' do
    it 'should work' do
