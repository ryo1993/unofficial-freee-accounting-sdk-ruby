...
# Unit tests for UnofficialFreeeSdk::QuotationUpdateParamsQuotationContents
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'QuotationUpdateParamsQuotationContents' do
  before do
    # run before each test
    @instance = UnofficialFreeeSdk::QuotationUpdateParamsQuotationContents.new
  end
  ...
  describe 'test an instance of QuotationUpdateParamsQuotationContents' do
    it 'should create an instance of QuotationUpdateParamsQuotationContents' do
      expect(@instance).to be_instance_of(UnofficialFreeeSdk::QuotationUpdateParamsQuotationContents)
    end
  end
