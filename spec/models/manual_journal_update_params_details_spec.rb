...
# Unit tests for UnofficialFreeeSdk::ManualJournalUpdateParamsDetails
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'ManualJournalUpdateParamsDetails' do
  before do
    # run before each test
    @instance = UnofficialFreeeSdk::ManualJournalUpdateParamsDetails.new
  end
  ...
  describe 'test an instance of ManualJournalUpdateParamsDetails' do
    it 'should create an instance of ManualJournalUpdateParamsDetails' do
      expect(@instance).to be_instance_of(UnofficialFreeeSdk::ManualJournalUpdateParamsDetails)
    end
  end
