...
# Unit tests for UnofficialFreeeSdk::TrialBsTwoYearsResponseTrialBsTwoYearsItems
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'TrialBsTwoYearsResponseTrialBsTwoYearsItems' do
  before do
    # run before each test
    @instance = UnofficialFreeeSdk::TrialBsTwoYearsResponseTrialBsTwoYearsItems.new
  end
  ...
  describe 'test an instance of TrialBsTwoYearsResponseTrialBsTwoYearsItems' do
    it 'should create an instance of TrialBsTwoYearsResponseTrialBsTwoYearsItems' do
      expect(@instance).to be_instance_of(UnofficialFreeeSdk::TrialBsTwoYearsResponseTrialBsTwoYearsItems)
    end
  end
