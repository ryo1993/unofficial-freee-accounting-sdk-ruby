...
# Unit tests for UnofficialFreeeSdk::TaxResponseTax
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'TaxResponseTax' do
  before do
    # run before each test
    @instance = UnofficialFreeeSdk::TaxResponseTax.new
  end
  ...
  describe 'test an instance of TaxResponseTax' do
    it 'should create an instance of TaxResponseTax' do
      expect(@instance).to be_instance_of(UnofficialFreeeSdk::TaxResponseTax)
    end
  end
