...
# Unit tests for UnofficialFreeeSdk::InlineResponse20013
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'InlineResponse20013' do
  before do
    # run before each test
    @instance = UnofficialFreeeSdk::InlineResponse20013.new
  end
  ...
  describe 'test an instance of InlineResponse20013' do
    it 'should create an instance of InlineResponse20013' do
      expect(@instance).to be_instance_of(UnofficialFreeeSdk::InlineResponse20013)
    end
  end
