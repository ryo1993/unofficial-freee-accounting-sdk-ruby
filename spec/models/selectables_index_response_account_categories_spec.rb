...
# Unit tests for UnofficialFreeeSdk::SelectablesIndexResponseAccountCategories
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'SelectablesIndexResponseAccountCategories' do
  before do
    # run before each test
    @instance = UnofficialFreeeSdk::SelectablesIndexResponseAccountCategories.new
  end
  ...
  describe 'test an instance of SelectablesIndexResponseAccountCategories' do
    it 'should create an instance of SelectablesIndexResponseAccountCategories' do
      expect(@instance).to be_instance_of(UnofficialFreeeSdk::SelectablesIndexResponseAccountCategories)
    end
  end
  describe 'test attribute "balance"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["expense", "income"])
  ...
  describe 'test attribute "org_code"' do
    it 'should work' do
      ...
      # validator.allowable_values.each do |value|
      #   expect { @instance.org_code = value }.not_to raise_error
      # end
    end
  end
