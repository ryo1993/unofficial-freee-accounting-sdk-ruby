...
# Unit tests for UnofficialFreeeSdk::JournalStatusResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'JournalStatusResponse' do
  before do
    # run before each test
    @instance = UnofficialFreeeSdk::JournalStatusResponse.new
  end
  ...
  describe 'test an instance of JournalStatusResponse' do
    it 'should create an instance of JournalStatusResponse' do
      expect(@instance).to be_instance_of(UnofficialFreeeSdk::JournalStatusResponse)
    end
  end
