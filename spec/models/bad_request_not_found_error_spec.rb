...
# Unit tests for UnofficialFreeeSdk::BadRequestNotFoundError
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'BadRequestNotFoundError' do
  before do
    # run before each test
    @instance = UnofficialFreeeSdk::BadRequestNotFoundError.new
  end
  ...
  describe 'test an instance of BadRequestNotFoundError' do
    it 'should create an instance of BadRequestNotFoundError' do
      expect(@instance).to be_instance_of(UnofficialFreeeSdk::BadRequestNotFoundError)
    end
  end
