...
# Unit tests for UnofficialFreeeSdk::DealCreateParams
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'DealCreateParams' do
  before do
    # run before each test
    @instance = UnofficialFreeeSdk::DealCreateParams.new
  end
  ...
  describe 'test an instance of DealCreateParams' do
    it 'should create an instance of DealCreateParams' do
      expect(@instance).to be_instance_of(UnofficialFreeeSdk::DealCreateParams)
    end
  end
