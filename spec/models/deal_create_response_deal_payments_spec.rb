...
# Unit tests for UnofficialFreeeSdk::DealCreateResponseDealPayments
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'DealCreateResponseDealPayments' do
  before do
    # run before each test
    @instance = UnofficialFreeeSdk::DealCreateResponseDealPayments.new
  end
  ...
  describe 'test an instance of DealCreateResponseDealPayments' do
    it 'should create an instance of DealCreateResponseDealPayments' do
      expect(@instance).to be_instance_of(UnofficialFreeeSdk::DealCreateResponseDealPayments)
    end
  end
  ...
  describe 'test attribute "from_walletable_type"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["bank_account", "credit_card", "wallet", "private_account_item"])
