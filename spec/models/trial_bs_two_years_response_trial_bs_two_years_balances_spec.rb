...
# Unit tests for UnofficialFreeeSdk::TrialBsTwoYearsResponseTrialBsTwoYearsBalances
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'TrialBsTwoYearsResponseTrialBsTwoYearsBalances' do
  before do
    # run before each test
    @instance = UnofficialFreeeSdk::TrialBsTwoYearsResponseTrialBsTwoYearsBalances.new
  end
  ...
  describe 'test an instance of TrialBsTwoYearsResponseTrialBsTwoYearsBalances' do
    it 'should create an instance of TrialBsTwoYearsResponseTrialBsTwoYearsBalances' do
      expect(@instance).to be_instance_of(UnofficialFreeeSdk::TrialBsTwoYearsResponseTrialBsTwoYearsBalances)
    end
  end
