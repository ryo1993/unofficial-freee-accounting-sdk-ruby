...
# Unit tests for UnofficialFreeeSdk::TrialPlSectionsResponseTrialPlSectionsSections
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'TrialPlSectionsResponseTrialPlSectionsSections' do
  before do
    # run before each test
    @instance = UnofficialFreeeSdk::TrialPlSectionsResponseTrialPlSectionsSections.new
  end
  ...
  describe 'test an instance of TrialPlSectionsResponseTrialPlSectionsSections' do
    it 'should create an instance of TrialPlSectionsResponseTrialPlSectionsSections' do
      expect(@instance).to be_instance_of(UnofficialFreeeSdk::TrialPlSectionsResponseTrialPlSectionsSections)
    end
  end
