...
# Unit tests for UnofficialFreeeSdk::PaymentParams
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'PaymentParams' do
  before do
    # run before each test
    @instance = UnofficialFreeeSdk::PaymentParams.new
  end
  ...
  describe 'test an instance of PaymentParams' do
    it 'should create an instance of PaymentParams' do
      expect(@instance).to be_instance_of(UnofficialFreeeSdk::PaymentParams)
    end
  end
