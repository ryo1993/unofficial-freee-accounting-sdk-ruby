...
# Unit tests for UnofficialFreeeSdk::CompanyResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'CompanyResponse' do
  before do
    # run before each test
    @instance = UnofficialFreeeSdk::CompanyResponse.new
  end
  ...
  describe 'test an instance of CompanyResponse' do
    it 'should create an instance of CompanyResponse' do
      expect(@instance).to be_instance_of(UnofficialFreeeSdk::CompanyResponse)
    end
  end
