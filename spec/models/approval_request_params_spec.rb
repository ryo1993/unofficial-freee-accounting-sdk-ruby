...
# Unit tests for UnofficialFreeeSdk::ApprovalRequestParams
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'ApprovalRequestParams' do
  before do
    # run before each test
    @instance = UnofficialFreeeSdk::ApprovalRequestParams.new
  end
  ...
  describe 'test an instance of ApprovalRequestParams' do
    it 'should create an instance of ApprovalRequestParams' do
      expect(@instance).to be_instance_of(UnofficialFreeeSdk::ApprovalRequestParams)
    end
  end
  ...
  describe 'test attribute "approval_flow_route_id"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
