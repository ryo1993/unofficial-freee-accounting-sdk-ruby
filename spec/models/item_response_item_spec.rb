...
# Unit tests for UnofficialFreeeSdk::ItemResponseItem
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'ItemResponseItem' do
  before do
    # run before each test
    @instance = UnofficialFreeeSdk::ItemResponseItem.new
  end
  ...
  describe 'test an instance of ItemResponseItem' do
    it 'should create an instance of ItemResponseItem' do
      expect(@instance).to be_instance_of(UnofficialFreeeSdk::ItemResponseItem)
    end
  end
