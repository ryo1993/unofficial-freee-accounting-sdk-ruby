...
# Unit tests for UnofficialFreeeSdk::AccountItemsResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'AccountItemsResponse' do
  before do
    # run before each test
    @instance = UnofficialFreeeSdk::AccountItemsResponse.new
  end
  ...
  describe 'test an instance of AccountItemsResponse' do
    it 'should create an instance of AccountItemsResponse' do
      expect(@instance).to be_instance_of(UnofficialFreeeSdk::AccountItemsResponse)
    end
  end
