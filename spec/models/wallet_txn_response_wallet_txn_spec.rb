...
# Unit tests for UnofficialFreeeSdk::WalletTxnResponseWalletTxn
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'WalletTxnResponseWalletTxn' do
  before do
    # run before each test
    @instance = UnofficialFreeeSdk::WalletTxnResponseWalletTxn.new
  end
  ...
  describe 'test an instance of WalletTxnResponseWalletTxn' do
    it 'should create an instance of WalletTxnResponseWalletTxn' do
      expect(@instance).to be_instance_of(UnofficialFreeeSdk::WalletTxnResponseWalletTxn)
    end
  end
  ...
  describe 'test attribute "entry_side"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["income", "expense"])
  ...
  describe 'test attribute "walletable_type"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["bank_account", "credit_card", "wallet"])
      # validator.allowable_values.each do |value|
      #   expect { @instance.walletable_type = value }.not_to raise_error
      # end
    end
  end
