...
# Unit tests for UnofficialFreeeSdk::SelectablesIndexResponseDefaultTaxTaxRate8
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'SelectablesIndexResponseDefaultTaxTaxRate8' do
  before do
    # run before each test
    @instance = UnofficialFreeeSdk::SelectablesIndexResponseDefaultTaxTaxRate8.new
  end
  ...
  describe 'test an instance of SelectablesIndexResponseDefaultTaxTaxRate8' do
    it 'should create an instance of SelectablesIndexResponseDefaultTaxTaxRate8' do
      expect(@instance).to be_instance_of(UnofficialFreeeSdk::SelectablesIndexResponseDefaultTaxTaxRate8)
    end
  end
