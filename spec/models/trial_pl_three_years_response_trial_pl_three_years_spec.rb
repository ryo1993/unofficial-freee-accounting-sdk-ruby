...
# Unit tests for UnofficialFreeeSdk::TrialPlThreeYearsResponseTrialPlThreeYears
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'TrialPlThreeYearsResponseTrialPlThreeYears' do
  before do
    # run before each test
    @instance = UnofficialFreeeSdk::TrialPlThreeYearsResponseTrialPlThreeYears.new
  end
  ...
  describe 'test an instance of TrialPlThreeYearsResponseTrialPlThreeYears' do
    it 'should create an instance of TrialPlThreeYearsResponseTrialPlThreeYears' do
      expect(@instance).to be_instance_of(UnofficialFreeeSdk::TrialPlThreeYearsResponseTrialPlThreeYears)
    end
  end
  ...
  describe 'test attribute "breakdown_display_type"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["partner", "item", "section", "account_item"])
      # validator.allowable_values.each do |value|
