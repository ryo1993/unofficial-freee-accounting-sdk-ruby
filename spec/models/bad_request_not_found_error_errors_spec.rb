...
# Unit tests for UnofficialFreeeSdk::BadRequestNotFoundErrorErrors
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'BadRequestNotFoundErrorErrors' do
  before do
    # run before each test
    @instance = UnofficialFreeeSdk::BadRequestNotFoundErrorErrors.new
  end
  ...
  describe 'test an instance of BadRequestNotFoundErrorErrors' do
    it 'should create an instance of BadRequestNotFoundErrorErrors' do
      expect(@instance).to be_instance_of(UnofficialFreeeSdk::BadRequestNotFoundErrorErrors)
    end
  end
  ...
  describe 'test attribute "type"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["status", "validation", "error"])
