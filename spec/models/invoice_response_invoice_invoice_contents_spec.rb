...
# Unit tests for UnofficialFreeeSdk::InvoiceResponseInvoiceInvoiceContents
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'InvoiceResponseInvoiceInvoiceContents' do
  before do
    # run before each test
    @instance = UnofficialFreeeSdk::InvoiceResponseInvoiceInvoiceContents.new
  end
  ...
  describe 'test an instance of InvoiceResponseInvoiceInvoiceContents' do
    it 'should create an instance of InvoiceResponseInvoiceInvoiceContents' do
      expect(@instance).to be_instance_of(UnofficialFreeeSdk::InvoiceResponseInvoiceInvoiceContents)
    end
  end
