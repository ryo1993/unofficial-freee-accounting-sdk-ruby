...
# Unit tests for UnofficialFreeeSdk::AccountItemParams
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'AccountItemParams' do
  before do
    # run before each test
    @instance = UnofficialFreeeSdk::AccountItemParams.new
  end
  ...
  describe 'test an instance of AccountItemParams' do
    it 'should create an instance of AccountItemParams' do
      expect(@instance).to be_instance_of(UnofficialFreeeSdk::AccountItemParams)
    end
  end
