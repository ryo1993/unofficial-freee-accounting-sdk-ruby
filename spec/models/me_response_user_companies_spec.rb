...
# Unit tests for UnofficialFreeeSdk::MeResponseUserCompanies
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'MeResponseUserCompanies' do
  before do
    # run before each test
    @instance = UnofficialFreeeSdk::MeResponseUserCompanies.new
  end
  ...
  describe 'test an instance of MeResponseUserCompanies' do
    it 'should create an instance of MeResponseUserCompanies' do
      expect(@instance).to be_instance_of(UnofficialFreeeSdk::MeResponseUserCompanies)
    end
  end
  ...
  describe 'test attribute "use_custom_role"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
