...
# Unit tests for UnofficialFreeeSdk::SelectablesIndexResponseDefaultTaxTaxRate5
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'SelectablesIndexResponseDefaultTaxTaxRate5' do
  before do
    # run before each test
    @instance = UnofficialFreeeSdk::SelectablesIndexResponseDefaultTaxTaxRate5.new
  end
  ...
  describe 'test an instance of SelectablesIndexResponseDefaultTaxTaxRate5' do
    it 'should create an instance of SelectablesIndexResponseDefaultTaxTaxRate5' do
      expect(@instance).to be_instance_of(UnofficialFreeeSdk::SelectablesIndexResponseDefaultTaxTaxRate5)
    end
  end
