...
# Unit tests for UnofficialFreeeSdk::SegmentTagParams
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'SegmentTagParams' do
  before do
    # run before each test
    @instance = UnofficialFreeeSdk::SegmentTagParams.new
  end
  ...
  describe 'test an instance of SegmentTagParams' do
    it 'should create an instance of SegmentTagParams' do
      expect(@instance).to be_instance_of(UnofficialFreeeSdk::SegmentTagParams)
    end
  end
