...
# Unit tests for UnofficialFreeeSdk::TaxResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'TaxResponse' do
  before do
    # run before each test
    @instance = UnofficialFreeeSdk::TaxResponse.new
  end
  ...
  describe 'test an instance of TaxResponse' do
    it 'should create an instance of TaxResponse' do
      expect(@instance).to be_instance_of(UnofficialFreeeSdk::TaxResponse)
    end
  end
