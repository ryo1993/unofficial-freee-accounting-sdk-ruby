...
# Unit tests for UnofficialFreeeSdk::JournalStatusResponseJournals
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'JournalStatusResponseJournals' do
  before do
    # run before each test
    @instance = UnofficialFreeeSdk::JournalStatusResponseJournals.new
  end
  ...
  describe 'test an instance of JournalStatusResponseJournals' do
    it 'should create an instance of JournalStatusResponseJournals' do
      expect(@instance).to be_instance_of(UnofficialFreeeSdk::JournalStatusResponseJournals)
    end
  end
  ...
  describe 'test attribute "download_type"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["csv", "generic", "pdf"])
      # validator.allowable_values.each do |value|
      #   expect { @instance.download_type = value }.not_to raise_error
      # end
    end
  end
  ...
  describe 'test attribute "status"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["enqueued", "working", "uploaded", "failed"])
      # validator.allowable_values.each do |value|
  ...
  describe 'test attribute "visible_tags"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('Array<String>', ["partner", "item", "tag", "section", "description", "wallet_txn_description", "all"])
      # validator.allowable_values.each do |value|
      #   expect { @instance.visible_tags = value }.not_to raise_error
      # end
    end
  end
