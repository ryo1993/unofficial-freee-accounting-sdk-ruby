...
# Unit tests for UnofficialFreeeSdk::InlineResponse20018
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'InlineResponse20018' do
  before do
    # run before each test
    @instance = UnofficialFreeeSdk::InlineResponse20018.new
  end
  ...
  describe 'test an instance of InlineResponse20018' do
    it 'should create an instance of InlineResponse20018' do
      expect(@instance).to be_instance_of(UnofficialFreeeSdk::InlineResponse20018)
    end
  end
  describe 'test attribute "expense_application_line_templates"' do
    it 'should work' do
