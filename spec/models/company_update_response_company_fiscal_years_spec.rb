...
# Unit tests for UnofficialFreeeSdk::CompanyUpdateResponseCompanyFiscalYears
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'CompanyUpdateResponseCompanyFiscalYears' do
  before do
    # run before each test
    @instance = UnofficialFreeeSdk::CompanyUpdateResponseCompanyFiscalYears.new
  end
  ...
  describe 'test an instance of CompanyUpdateResponseCompanyFiscalYears' do
    it 'should create an instance of CompanyUpdateResponseCompanyFiscalYears' do
      expect(@instance).to be_instance_of(UnofficialFreeeSdk::CompanyUpdateResponseCompanyFiscalYears)
    end
  end
  describe 'test attribute "use_industry_template"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "indirect_write_off_method"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
  ...
  describe 'test attribute "depreciation_record_method"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
  ...
  describe 'test attribute "sales_tax_business_code"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "tax_fraction"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "tax_account_method"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
