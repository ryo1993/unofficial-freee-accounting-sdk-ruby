...
# Unit tests for UnofficialFreeeSdk::ManualJournalResponseManualJournalDetails
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'ManualJournalResponseManualJournalDetails' do
  before do
    # run before each test
    @instance = UnofficialFreeeSdk::ManualJournalResponseManualJournalDetails.new
  end
  ...
  describe 'test an instance of ManualJournalResponseManualJournalDetails' do
    it 'should create an instance of ManualJournalResponseManualJournalDetails' do
      expect(@instance).to be_instance_of(UnofficialFreeeSdk::ManualJournalResponseManualJournalDetails)
    end
  end
  ...
  describe 'test attribute "entry_side"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["credit", "debit"])
      # validator.allowable_values.each do |value|
      #   expect { @instance.entry_side = value }.not_to raise_error
      # end
    end
  end
