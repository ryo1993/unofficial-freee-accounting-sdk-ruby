...
# Unit tests for UnofficialFreeeSdk::TagParams
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'TagParams' do
  before do
    # run before each test
    @instance = UnofficialFreeeSdk::TagParams.new
  end
  ...
  describe 'test an instance of TagParams' do
    it 'should create an instance of TagParams' do
      expect(@instance).to be_instance_of(UnofficialFreeeSdk::TagParams)
    end
  end
