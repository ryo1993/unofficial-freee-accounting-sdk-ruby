...
# Unit tests for UnofficialFreeeSdk::WalletTxnResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'WalletTxnResponse' do
  before do
    # run before each test
    @instance = UnofficialFreeeSdk::WalletTxnResponse.new
  end
  ...
  describe 'test an instance of WalletTxnResponse' do
    it 'should create an instance of WalletTxnResponse' do
      expect(@instance).to be_instance_of(UnofficialFreeeSdk::WalletTxnResponse)
    end
  end
  describe 'test attribute "wallet_txn"' do
    it 'should work' do
