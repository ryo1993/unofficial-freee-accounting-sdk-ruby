...
# Unit tests for UnofficialFreeeSdk::ManualJournalCreateParamsDetails
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'ManualJournalCreateParamsDetails' do
  before do
    # run before each test
    @instance = UnofficialFreeeSdk::ManualJournalCreateParamsDetails.new
  end
  ...
  describe 'test an instance of ManualJournalCreateParamsDetails' do
    it 'should create an instance of ManualJournalCreateParamsDetails' do
      expect(@instance).to be_instance_of(UnofficialFreeeSdk::ManualJournalCreateParamsDetails)
    end
  end
