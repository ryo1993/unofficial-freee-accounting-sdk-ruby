...
# Unit tests for UnofficialFreeeSdk::ManualJournalResponseManualJournal
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'ManualJournalResponseManualJournal' do
  before do
    # run before each test
    @instance = UnofficialFreeeSdk::ManualJournalResponseManualJournal.new
  end
  ...
  describe 'test an instance of ManualJournalResponseManualJournal' do
    it 'should create an instance of ManualJournalResponseManualJournal' do
      expect(@instance).to be_instance_of(UnofficialFreeeSdk::ManualJournalResponseManualJournal)
    end
  end
  ...
  describe 'test attribute "txn_number"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
