...
# Unit tests for UnofficialFreeeSdk::ApprovalRequestResponseApprovalRequestRequestItems
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'ApprovalRequestResponseApprovalRequestRequestItems' do
  before do
    # run before each test
    @instance = UnofficialFreeeSdk::ApprovalRequestResponseApprovalRequestRequestItems.new
  end
  ...
  describe 'test an instance of ApprovalRequestResponseApprovalRequestRequestItems' do
    it 'should create an instance of ApprovalRequestResponseApprovalRequestRequestItems' do
      expect(@instance).to be_instance_of(UnofficialFreeeSdk::ApprovalRequestResponseApprovalRequestRequestItems)
    end
  end
