...
# Unit tests for UnofficialFreeeSdk::InvoiceResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'InvoiceResponse' do
  before do
    # run before each test
    @instance = UnofficialFreeeSdk::InvoiceResponse.new
  end
  ...
  describe 'test an instance of InvoiceResponse' do
    it 'should create an instance of InvoiceResponse' do
      expect(@instance).to be_instance_of(UnofficialFreeeSdk::InvoiceResponse)
    end
  end
