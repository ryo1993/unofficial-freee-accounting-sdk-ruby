...
# Unit tests for UnofficialFreeeSdk::ForbiddenError
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'ForbiddenError' do
  before do
    # run before each test
    @instance = UnofficialFreeeSdk::ForbiddenError.new
  end
  ...
  describe 'test an instance of ForbiddenError' do
    it 'should create an instance of ForbiddenError' do
      expect(@instance).to be_instance_of(UnofficialFreeeSdk::ForbiddenError)
    end
  end
