...
# Unit tests for UnofficialFreeeSdk::TrialBsThreeYearsResponseTrialBsThreeYearsBalances
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'TrialBsThreeYearsResponseTrialBsThreeYearsBalances' do
  before do
    # run before each test
    @instance = UnofficialFreeeSdk::TrialBsThreeYearsResponseTrialBsThreeYearsBalances.new
  end
  ...
  describe 'test an instance of TrialBsThreeYearsResponseTrialBsThreeYearsBalances' do
    it 'should create an instance of TrialBsThreeYearsResponseTrialBsThreeYearsBalances' do
      expect(@instance).to be_instance_of(UnofficialFreeeSdk::TrialBsThreeYearsResponseTrialBsThreeYearsBalances)
    end
  end
