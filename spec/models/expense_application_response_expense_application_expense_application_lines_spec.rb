...
# Unit tests for UnofficialFreeeSdk::ExpenseApplicationResponseExpenseApplicationExpenseApplicationLines
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'ExpenseApplicationResponseExpenseApplicationExpenseApplicationLines' do
  before do
    # run before each test
    @instance = UnofficialFreeeSdk::ExpenseApplicationResponseExpenseApplicationExpenseApplicationLines.new
  end
  ...
  describe 'test an instance of ExpenseApplicationResponseExpenseApplicationExpenseApplicationLines' do
    it 'should create an instance of ExpenseApplicationResponseExpenseApplicationExpenseApplicationLines' do
      expect(@instance).to be_instance_of(UnofficialFreeeSdk::ExpenseApplicationResponseExpenseApplicationExpenseApplicationLines)
    end
  end
  ...
  describe 'test attribute "expense_application_line_template_id"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
