...
# Unit tests for UnofficialFreeeSdk::ReceiptUpdateParams
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'ReceiptUpdateParams' do
  before do
    # run before each test
    @instance = UnofficialFreeeSdk::ReceiptUpdateParams.new
  end
  ...
  describe 'test an instance of ReceiptUpdateParams' do
    it 'should create an instance of ReceiptUpdateParams' do
      expect(@instance).to be_instance_of(UnofficialFreeeSdk::ReceiptUpdateParams)
    end
  end
