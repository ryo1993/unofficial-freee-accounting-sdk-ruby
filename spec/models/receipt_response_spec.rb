...
# Unit tests for UnofficialFreeeSdk::ReceiptResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'ReceiptResponse' do
  before do
    # run before each test
    @instance = UnofficialFreeeSdk::ReceiptResponse.new
  end
  ...
  describe 'test an instance of ReceiptResponse' do
    it 'should create an instance of ReceiptResponse' do
      expect(@instance).to be_instance_of(UnofficialFreeeSdk::ReceiptResponse)
    end
  end
