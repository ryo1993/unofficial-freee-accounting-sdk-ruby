...
# Unit tests for UnofficialFreeeSdk::DealCreateParamsPayments
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'DealCreateParamsPayments' do
  before do
    # run before each test
    @instance = UnofficialFreeeSdk::DealCreateParamsPayments.new
  end
  ...
  describe 'test an instance of DealCreateParamsPayments' do
    it 'should create an instance of DealCreateParamsPayments' do
      expect(@instance).to be_instance_of(UnofficialFreeeSdk::DealCreateParamsPayments)
    end
  end
