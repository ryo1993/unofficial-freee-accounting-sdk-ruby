...
# Unit tests for UnofficialFreeeSdk::BadRequestErrorErrors
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'BadRequestErrorErrors' do
  before do
    # run before each test
    @instance = UnofficialFreeeSdk::BadRequestErrorErrors.new
  end
  ...
  describe 'test an instance of BadRequestErrorErrors' do
    it 'should create an instance of BadRequestErrorErrors' do
      expect(@instance).to be_instance_of(UnofficialFreeeSdk::BadRequestErrorErrors)
    end
  end
