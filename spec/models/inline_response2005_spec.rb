...
# Unit tests for UnofficialFreeeSdk::InlineResponse2005
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'InlineResponse2005' do
  before do
    # run before each test
    @instance = UnofficialFreeeSdk::InlineResponse2005.new
  end
  ...
  describe 'test an instance of InlineResponse2005' do
    it 'should create an instance of InlineResponse2005' do
      expect(@instance).to be_instance_of(UnofficialFreeeSdk::InlineResponse2005)
    end
  end
