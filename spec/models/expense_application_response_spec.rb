...
# Unit tests for UnofficialFreeeSdk::ExpenseApplicationResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'ExpenseApplicationResponse' do
  before do
    # run before each test
    @instance = UnofficialFreeeSdk::ExpenseApplicationResponse.new
  end
  ...
  describe 'test an instance of ExpenseApplicationResponse' do
    it 'should create an instance of ExpenseApplicationResponse' do
      expect(@instance).to be_instance_of(UnofficialFreeeSdk::ExpenseApplicationResponse)
    end
  end
  describe 'test attribute "expense_application"' do
    it 'should work' do
