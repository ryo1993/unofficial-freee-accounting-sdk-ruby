...
# Unit tests for UnofficialFreeeSdk::ItemResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'ItemResponse' do
  before do
    # run before each test
    @instance = UnofficialFreeeSdk::ItemResponse.new
  end
  ...
  describe 'test an instance of ItemResponse' do
    it 'should create an instance of ItemResponse' do
      expect(@instance).to be_instance_of(UnofficialFreeeSdk::ItemResponse)
    end
  end
