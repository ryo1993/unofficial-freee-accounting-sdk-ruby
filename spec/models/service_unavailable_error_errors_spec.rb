...
# Unit tests for UnofficialFreeeSdk::ServiceUnavailableErrorErrors
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'ServiceUnavailableErrorErrors' do
  before do
    # run before each test
    @instance = UnofficialFreeeSdk::ServiceUnavailableErrorErrors.new
  end
  ...
  describe 'test an instance of ServiceUnavailableErrorErrors' do
    it 'should create an instance of ServiceUnavailableErrorErrors' do
      expect(@instance).to be_instance_of(UnofficialFreeeSdk::ServiceUnavailableErrorErrors)
    end
  end
  ...
  describe 'test attribute "type"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["status", "error"])
