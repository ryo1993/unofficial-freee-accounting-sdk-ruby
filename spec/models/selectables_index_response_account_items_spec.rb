...
# Unit tests for UnofficialFreeeSdk::SelectablesIndexResponseAccountItems
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'SelectablesIndexResponseAccountItems' do
  before do
    # run before each test
    @instance = UnofficialFreeeSdk::SelectablesIndexResponseAccountItems.new
  end
  ...
  describe 'test an instance of SelectablesIndexResponseAccountItems' do
    it 'should create an instance of SelectablesIndexResponseAccountItems' do
      expect(@instance).to be_instance_of(UnofficialFreeeSdk::SelectablesIndexResponseAccountItems)
    end
  end
