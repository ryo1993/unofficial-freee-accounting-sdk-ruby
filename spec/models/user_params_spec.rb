...
# Unit tests for UnofficialFreeeSdk::UserParams
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'UserParams' do
  before do
    # run before each test
    @instance = UnofficialFreeeSdk::UserParams.new
  end
  ...
  describe 'test an instance of UserParams' do
    it 'should create an instance of UserParams' do
      expect(@instance).to be_instance_of(UnofficialFreeeSdk::UserParams)
    end
  end
