...
# Unit tests for UnofficialFreeeSdk::ExpenseApplicationLineTemplateResponseExpenseApplicationLineTemplate
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'ExpenseApplicationLineTemplateResponseExpenseApplicationLineTemplate' do
  before do
    # run before each test
    @instance = UnofficialFreeeSdk::ExpenseApplicationLineTemplateResponseExpenseApplicationLineTemplate.new
  end
  ...
  describe 'test an instance of ExpenseApplicationLineTemplateResponseExpenseApplicationLineTemplate' do
    it 'should create an instance of ExpenseApplicationLineTemplateResponseExpenseApplicationLineTemplate' do
      expect(@instance).to be_instance_of(UnofficialFreeeSdk::ExpenseApplicationLineTemplateResponseExpenseApplicationLineTemplate)
    end
  end
  ...
  describe 'test attribute "line_description"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
