...
# Unit tests for UnofficialFreeeSdk::DealUpdateParams
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'DealUpdateParams' do
  before do
    # run before each test
    @instance = UnofficialFreeeSdk::DealUpdateParams.new
  end
  ...
  describe 'test an instance of DealUpdateParams' do
    it 'should create an instance of DealUpdateParams' do
      expect(@instance).to be_instance_of(UnofficialFreeeSdk::DealUpdateParams)
    end
  end
  ...
  describe 'test attribute "receipt_ids"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
