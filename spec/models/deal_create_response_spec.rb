...
# Unit tests for UnofficialFreeeSdk::DealCreateResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'DealCreateResponse' do
  before do
    # run before each test
    @instance = UnofficialFreeeSdk::DealCreateResponse.new
  end
  ...
  describe 'test an instance of DealCreateResponse' do
    it 'should create an instance of DealCreateResponse' do
      expect(@instance).to be_instance_of(UnofficialFreeeSdk::DealCreateResponse)
    end
  end
