...
# Unit tests for UnofficialFreeeSdk::UserResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'UserResponse' do
  before do
    # run before each test
    @instance = UnofficialFreeeSdk::UserResponse.new
  end
  ...
  describe 'test an instance of UserResponse' do
    it 'should create an instance of UserResponse' do
      expect(@instance).to be_instance_of(UnofficialFreeeSdk::UserResponse)
    end
  end
