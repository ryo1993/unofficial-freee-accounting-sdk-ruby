...
# Unit tests for UnofficialFreeeSdk::TrialPlSectionsResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'TrialPlSectionsResponse' do
  before do
    # run before each test
    @instance = UnofficialFreeeSdk::TrialPlSectionsResponse.new
  end
  ...
  describe 'test an instance of TrialPlSectionsResponse' do
    it 'should create an instance of TrialPlSectionsResponse' do
      expect(@instance).to be_instance_of(UnofficialFreeeSdk::TrialPlSectionsResponse)
    end
  end
  describe 'test attribute "trial_pl_sections"' do
    it 'should work' do
