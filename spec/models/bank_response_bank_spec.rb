...
# Unit tests for UnofficialFreeeSdk::BankResponseBank
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'BankResponseBank' do
  before do
    # run before each test
    @instance = UnofficialFreeeSdk::BankResponseBank.new
  end
  ...
  describe 'test an instance of BankResponseBank' do
    it 'should create an instance of BankResponseBank' do
      expect(@instance).to be_instance_of(UnofficialFreeeSdk::BankResponseBank)
    end
  end
