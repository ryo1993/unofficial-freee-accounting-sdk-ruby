...
# Unit tests for UnofficialFreeeSdk::TrialPlThreeYearsResponseTrialPlThreeYearsSections
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'TrialPlThreeYearsResponseTrialPlThreeYearsSections' do
  before do
    # run before each test
    @instance = UnofficialFreeeSdk::TrialPlThreeYearsResponseTrialPlThreeYearsSections.new
  end
  ...
  describe 'test an instance of TrialPlThreeYearsResponseTrialPlThreeYearsSections' do
    it 'should create an instance of TrialPlThreeYearsResponseTrialPlThreeYearsSections' do
      expect(@instance).to be_instance_of(UnofficialFreeeSdk::TrialPlThreeYearsResponseTrialPlThreeYearsSections)
    end
  end
