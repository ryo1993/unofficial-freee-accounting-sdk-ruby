...
# Unit tests for UnofficialFreeeSdk::AccountItemResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'AccountItemResponse' do
  before do
    # run before each test
    @instance = UnofficialFreeeSdk::AccountItemResponse.new
  end
  ...
  describe 'test an instance of AccountItemResponse' do
    it 'should create an instance of AccountItemResponse' do
      expect(@instance).to be_instance_of(UnofficialFreeeSdk::AccountItemResponse)
    end
  end
  describe 'test attribute "account_item"' do
    it 'should work' do
