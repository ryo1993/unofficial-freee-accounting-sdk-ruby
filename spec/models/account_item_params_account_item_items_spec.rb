...
# Unit tests for UnofficialFreeeSdk::AccountItemParamsAccountItemItems
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'AccountItemParamsAccountItemItems' do
  before do
    # run before each test
    @instance = UnofficialFreeeSdk::AccountItemParamsAccountItemItems.new
  end
  ...
  describe 'test an instance of AccountItemParamsAccountItemItems' do
    it 'should create an instance of AccountItemParamsAccountItemItems' do
      expect(@instance).to be_instance_of(UnofficialFreeeSdk::AccountItemParamsAccountItemItems)
    end
  end
