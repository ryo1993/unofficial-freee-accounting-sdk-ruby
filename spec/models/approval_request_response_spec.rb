...
# Unit tests for UnofficialFreeeSdk::ApprovalRequestResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'ApprovalRequestResponse' do
  before do
    # run before each test
    @instance = UnofficialFreeeSdk::ApprovalRequestResponse.new
  end
  ...
  describe 'test an instance of ApprovalRequestResponse' do
    it 'should create an instance of ApprovalRequestResponse' do
      expect(@instance).to be_instance_of(UnofficialFreeeSdk::ApprovalRequestResponse)
    end
  end
  describe 'test attribute "approval_request"' do
    it 'should work' do
