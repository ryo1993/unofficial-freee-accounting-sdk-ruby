...
# Unit tests for UnofficialFreeeSdk::AccountItemResponseAccountItemItems
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'AccountItemResponseAccountItemItems' do
  before do
    # run before each test
    @instance = UnofficialFreeeSdk::AccountItemResponseAccountItemItems.new
  end
  ...
  describe 'test an instance of AccountItemResponseAccountItemItems' do
    it 'should create an instance of AccountItemResponseAccountItemItems' do
      expect(@instance).to be_instance_of(UnofficialFreeeSdk::AccountItemResponseAccountItemItems)
    end
  end
