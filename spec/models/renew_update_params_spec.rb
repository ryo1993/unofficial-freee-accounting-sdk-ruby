...
# Unit tests for UnofficialFreeeSdk::RenewUpdateParams
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'RenewUpdateParams' do
  before do
    # run before each test
    @instance = UnofficialFreeeSdk::RenewUpdateParams.new
  end
  ...
  describe 'test an instance of RenewUpdateParams' do
    it 'should create an instance of RenewUpdateParams' do
      expect(@instance).to be_instance_of(UnofficialFreeeSdk::RenewUpdateParams)
    end
  end
