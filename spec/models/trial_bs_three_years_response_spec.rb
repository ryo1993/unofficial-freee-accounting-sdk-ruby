...
# Unit tests for UnofficialFreeeSdk::TrialBsThreeYearsResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'TrialBsThreeYearsResponse' do
  before do
    # run before each test
    @instance = UnofficialFreeeSdk::TrialBsThreeYearsResponse.new
  end
  ...
  describe 'test an instance of TrialBsThreeYearsResponse' do
    it 'should create an instance of TrialBsThreeYearsResponse' do
      expect(@instance).to be_instance_of(UnofficialFreeeSdk::TrialBsThreeYearsResponse)
    end
  end
  describe 'test attribute "trial_bs_three_years"' do
    it 'should work' do
