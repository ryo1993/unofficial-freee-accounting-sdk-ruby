...
# Unit tests for UnofficialFreeeSdk::TrialBsTwoYearsResponseTrialBsTwoYears
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'TrialBsTwoYearsResponseTrialBsTwoYears' do
  before do
    # run before each test
    @instance = UnofficialFreeeSdk::TrialBsTwoYearsResponseTrialBsTwoYears.new
  end
  ...
  describe 'test an instance of TrialBsTwoYearsResponseTrialBsTwoYears' do
    it 'should create an instance of TrialBsTwoYearsResponseTrialBsTwoYears' do
      expect(@instance).to be_instance_of(UnofficialFreeeSdk::TrialBsTwoYearsResponseTrialBsTwoYears)
    end
  end
