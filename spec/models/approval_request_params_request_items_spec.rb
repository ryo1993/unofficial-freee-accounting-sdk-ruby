...
# Unit tests for UnofficialFreeeSdk::ApprovalRequestParamsRequestItems
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'ApprovalRequestParamsRequestItems' do
  before do
    # run before each test
    @instance = UnofficialFreeeSdk::ApprovalRequestParamsRequestItems.new
  end
  ...
  describe 'test an instance of ApprovalRequestParamsRequestItems' do
    it 'should create an instance of ApprovalRequestParamsRequestItems' do
      expect(@instance).to be_instance_of(UnofficialFreeeSdk::ApprovalRequestParamsRequestItems)
    end
  end
  ...
  describe 'test attribute "type"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["single_line", "multi_line", "select", "date", "amount", "receipt"])
