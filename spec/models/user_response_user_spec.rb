...
# Unit tests for UnofficialFreeeSdk::UserResponseUser
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'UserResponseUser' do
  before do
    # run before each test
    @instance = UnofficialFreeeSdk::UserResponseUser.new
  end
  ...
  describe 'test an instance of UserResponseUser' do
    it 'should create an instance of UserResponseUser' do
      expect(@instance).to be_instance_of(UnofficialFreeeSdk::UserResponseUser)
    end
  end
