...
# Unit tests for UnofficialFreeeSdk::TrialBsThreeYearsResponseTrialBsThreeYearsItems
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'TrialBsThreeYearsResponseTrialBsThreeYearsItems' do
  before do
    # run before each test
    @instance = UnofficialFreeeSdk::TrialBsThreeYearsResponseTrialBsThreeYearsItems.new
  end
  ...
  describe 'test an instance of TrialBsThreeYearsResponseTrialBsThreeYearsItems' do
    it 'should create an instance of TrialBsThreeYearsResponseTrialBsThreeYearsItems' do
      expect(@instance).to be_instance_of(UnofficialFreeeSdk::TrialBsThreeYearsResponseTrialBsThreeYearsItems)
    end
  end
