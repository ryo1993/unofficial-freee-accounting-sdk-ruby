...
# Unit tests for UnofficialFreeeSdk::CompanyIndexResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'CompanyIndexResponse' do
  before do
    # run before each test
    @instance = UnofficialFreeeSdk::CompanyIndexResponse.new
  end
  ...
  describe 'test an instance of CompanyIndexResponse' do
    it 'should create an instance of CompanyIndexResponse' do
      expect(@instance).to be_instance_of(UnofficialFreeeSdk::CompanyIndexResponse)
    end
  end
