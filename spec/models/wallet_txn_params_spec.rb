...
# Unit tests for UnofficialFreeeSdk::WalletTxnParams
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'WalletTxnParams' do
  before do
    # run before each test
    @instance = UnofficialFreeeSdk::WalletTxnParams.new
  end
  ...
  describe 'test an instance of WalletTxnParams' do
    it 'should create an instance of WalletTxnParams' do
      expect(@instance).to be_instance_of(UnofficialFreeeSdk::WalletTxnParams)
    end
  end
