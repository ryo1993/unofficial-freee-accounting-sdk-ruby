...
# Unit tests for UnofficialFreeeSdk::TrialPlTwoYearsResponseTrialPlTwoYearsSections
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'TrialPlTwoYearsResponseTrialPlTwoYearsSections' do
  before do
    # run before each test
    @instance = UnofficialFreeeSdk::TrialPlTwoYearsResponseTrialPlTwoYearsSections.new
  end
  ...
  describe 'test an instance of TrialPlTwoYearsResponseTrialPlTwoYearsSections' do
    it 'should create an instance of TrialPlTwoYearsResponseTrialPlTwoYearsSections' do
      expect(@instance).to be_instance_of(UnofficialFreeeSdk::TrialPlTwoYearsResponseTrialPlTwoYearsSections)
    end
  end
