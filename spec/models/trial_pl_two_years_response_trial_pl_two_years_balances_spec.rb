...
# Unit tests for UnofficialFreeeSdk::TrialPlTwoYearsResponseTrialPlTwoYearsBalances
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'TrialPlTwoYearsResponseTrialPlTwoYearsBalances' do
  before do
    # run before each test
    @instance = UnofficialFreeeSdk::TrialPlTwoYearsResponseTrialPlTwoYearsBalances.new
  end
  ...
  describe 'test an instance of TrialPlTwoYearsResponseTrialPlTwoYearsBalances' do
    it 'should create an instance of TrialPlTwoYearsResponseTrialPlTwoYearsBalances' do
      expect(@instance).to be_instance_of(UnofficialFreeeSdk::TrialPlTwoYearsResponseTrialPlTwoYearsBalances)
    end
  end
