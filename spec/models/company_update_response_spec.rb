...
# Unit tests for UnofficialFreeeSdk::CompanyUpdateResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'CompanyUpdateResponse' do
  before do
    # run before each test
    @instance = UnofficialFreeeSdk::CompanyUpdateResponse.new
  end
  ...
  describe 'test an instance of CompanyUpdateResponse' do
    it 'should create an instance of CompanyUpdateResponse' do
      expect(@instance).to be_instance_of(UnofficialFreeeSdk::CompanyUpdateResponse)
    end
  end
