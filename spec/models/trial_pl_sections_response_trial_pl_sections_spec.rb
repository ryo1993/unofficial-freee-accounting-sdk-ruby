...
# Unit tests for UnofficialFreeeSdk::TrialPlSectionsResponseTrialPlSections
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'TrialPlSectionsResponseTrialPlSections' do
  before do
    # run before each test
    @instance = UnofficialFreeeSdk::TrialPlSectionsResponseTrialPlSections.new
  end
  ...
  describe 'test an instance of TrialPlSectionsResponseTrialPlSections' do
    it 'should create an instance of TrialPlSectionsResponseTrialPlSections' do
      expect(@instance).to be_instance_of(UnofficialFreeeSdk::TrialPlSectionsResponseTrialPlSections)
    end
  end
  ...
  describe 'test attribute "section_ids"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
  ...
  describe 'test attribute "account_item_display_type"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["account_item", "group"])
      # validator.allowable_values.each do |value|
      #   expect { @instance.account_item_display_type = value }.not_to raise_error
      # end
    end
  end

  describe 'test attribute "breakdown_display_type"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["partner", "item", "account_item"])
      # validator.allowable_values.each do |value|
      #   expect { @instance.breakdown_display_type = value }.not_to raise_error
      # end
    end
  end
  ...
  describe 'test attribute "adjustment"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["only", "without"])
      # validator.allowable_values.each do |value|
      #   expect { @instance.adjustment = value }.not_to raise_error
      # end
    end
  end
  ...
  describe 'test attribute "cost_allocation"' do
    it 'should work' do
      ...
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["only", "without"])
      # validator.allowable_values.each do |value|
      #   expect { @instance.cost_allocation = value }.not_to raise_error
      # end
    end
  end
