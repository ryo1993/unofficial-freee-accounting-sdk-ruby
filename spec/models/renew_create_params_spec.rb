...
# Unit tests for UnofficialFreeeSdk::RenewCreateParams
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'RenewCreateParams' do
  before do
    # run before each test
    @instance = UnofficialFreeeSdk::RenewCreateParams.new
  end
  ...
  describe 'test an instance of RenewCreateParams' do
    it 'should create an instance of RenewCreateParams' do
      expect(@instance).to be_instance_of(UnofficialFreeeSdk::RenewCreateParams)
    end
  end
