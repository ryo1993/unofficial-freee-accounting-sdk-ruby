...
module UnofficialFreeeSdk
  class TaxesApi
    ...
    # @param code [Integer] 税区分コード
    # @param [Hash] opts the optional parameters
    # @return [TaxResponse]
    def get_tax_code(code, opts = {})
      data, _status_code, _headers = get_tax_code_with_http_info(code, opts)
      data
    end
    ...
    # @param code [Integer] 税区分コード
    # @param [Hash] opts the optional parameters
    # @return [Array<(TaxResponse, Integer, Hash)>] TaxResponse data, response status code and response headers
    def get_tax_code_with_http_info(code, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: TaxesApi.get_tax_code ...'
      end
      # verify the required parameter 'code' is set
      if @api_client.config.client_side_validation && code.nil?
        fail ArgumentError, "Missing the required parameter 'code' when calling TaxesApi.get_tax_code"
      end
      # resource path
      local_var_path = '/api/1/taxes/codes/{code}'.sub('{' + 'code' + '}', CGI.escape(code.to_s))
      ...
      # return_type
      return_type = opts[:return_type] || 'TaxResponse' 
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: TaxesApi#get_tax_code\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    def get_tax_codes(opts = {})
      data, _status_code, _headers = get_tax_codes_with_http_info(opts)
      data
    end
    ...
    def get_tax_codes_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: TaxesApi.get_tax_codes ...'
      end
      # resource path
      local_var_path = '/api/1/taxes/codes'
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: TaxesApi#get_tax_codes\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def get_taxes_companies(company_id, opts = {})
      data, _status_code, _headers = get_taxes_companies_with_http_info(company_id, opts)
      data
    end
    ...
    def get_taxes_companies_with_http_info(company_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: TaxesApi.get_taxes_companies ...'
      end
      # verify the required parameter 'company_id' is set
      if @api_client.config.client_side_validation && company_id.nil?
        fail ArgumentError, "Missing the required parameter 'company_id' when calling TaxesApi.get_taxes_companies"
      end
      if @api_client.config.client_side_validation && company_id > 4294967295
        fail ArgumentError, 'invalid value for "company_id" when calling TaxesApi.get_taxes_companies, must be smaller than or equal to 4294967295.'
      end

      if @api_client.config.client_side_validation && company_id < 1
        fail ArgumentError, 'invalid value for "company_id" when calling TaxesApi.get_taxes_companies, must be greater than or equal to 1.'
      end

      # resource path
      local_var_path = '/api/1/taxes/companies/{company_id}'.sub('{' + 'company_id' + '}', CGI.escape(company_id.to_s))
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: TaxesApi#get_taxes_companies\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
