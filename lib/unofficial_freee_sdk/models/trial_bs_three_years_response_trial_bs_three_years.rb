...
module UnofficialFreeeSdk
  class TrialBsThreeYearsResponseTrialBsThreeYears
    # 事業所ID
    ...
    def self.openapi_types
      {
        ...
        :'adjustment' => :'String',
        :'created_at' => :'String',
        :'balances' => :'Array<TrialBsThreeYearsResponseTrialBsThreeYearsBalances>'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `UnofficialFreeeSdk::TrialBsThreeYearsResponseTrialBsThreeYears` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `UnofficialFreeeSdk::TrialBsThreeYearsResponseTrialBsThreeYears`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def hash
      [company_id, up_to_date, fiscal_year, start_month, end_month, start_date, end_date, account_item_display_type, breakdown_display_type, partner_id, partner_code, item_id, adjustment, created_at, balances].hash
    end
