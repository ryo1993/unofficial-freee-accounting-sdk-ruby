...
module UnofficialFreeeSdk
  class InvoiceCreateParams
    ...
    attr_accessor :use_virtual_transfer_account
    ...
    def self.openapi_types
      {
        ...
        :'invoice_contents' => :'Array<InvoiceCreateParamsInvoiceContents>'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `UnofficialFreeeSdk::InvoiceCreateParams` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `UnofficialFreeeSdk::InvoiceCreateParams`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'use_virtual_transfer_account')
        self.use_virtual_transfer_account = attributes[:'use_virtual_transfer_account']
      end
    ...
    def valid?
      ...
      invoice_status_validator = EnumAttributeValidator.new('String', ["draft", "issue"])
      ...
      use_virtual_transfer_account_validator = EnumAttributeValidator.new('String', ["not_use", "use"])
      return false unless use_virtual_transfer_account_validator.valid?(@use_virtual_transfer_account)
    ...
    def invoice_status=(invoice_status)
      validator = EnumAttributeValidator.new('String', ["draft", "issue"])
    ...
    # Custom attribute writer method checking allowed values (enum).
    # @param [Object] use_virtual_transfer_account Object to be assigned
    def use_virtual_transfer_account=(use_virtual_transfer_account)
      validator = EnumAttributeValidator.new('String', ["not_use", "use"])
      unless validator.valid?(use_virtual_transfer_account)
        fail ArgumentError, "invalid value for \"use_virtual_transfer_account\", must be one of #{validator.allowable_values}."
      end
      @use_virtual_transfer_account = use_virtual_transfer_account
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          use_virtual_transfer_account == o.use_virtual_transfer_account &&
          message == o.message &&
          notes == o.notes &&
    ...
    def hash
      [company_id, issue_date, partner_id, partner_code, invoice_number, title, due_date, booking_date, description, invoice_status, partner_name, partner_title, partner_contact_info, partner_zipcode, partner_prefecture_code, partner_address1, partner_address2, company_name, company_zipcode, company_prefecture_code, company_address1, company_address2, company_contact_info, payment_type, payment_bank_info, use_virtual_transfer_account, message, notes, invoice_layout, tax_entry_method, invoice_contents].hash
    end
