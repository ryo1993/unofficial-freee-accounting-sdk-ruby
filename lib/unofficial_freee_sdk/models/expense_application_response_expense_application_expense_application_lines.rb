...
module UnofficialFreeeSdk
  class ExpenseApplicationResponseExpenseApplicationExpenseApplicationLines
    # 経費申請の項目行ID
    attr_accessor :id
    ...
    # 経費科目ID
    attr_accessor :expense_application_line_template_id
    ...
    def self.openapi_types
      {
        ...
        :'description' => :'String',
        :'amount' => :'Integer',
        :'expense_application_line_template_id' => :'Integer',
        :'receipt_id' => :'Integer'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `UnofficialFreeeSdk::ExpenseApplicationResponseExpenseApplicationExpenseApplicationLines` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `UnofficialFreeeSdk::ExpenseApplicationResponseExpenseApplicationExpenseApplicationLines`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'expense_application_line_template_id')
        self.expense_application_line_template_id = attributes[:'expense_application_line_template_id']
      end
    ...
    def list_invalid_properties
      ...
      if !@amount.nil? && @amount > 1000000000
        invalid_properties.push('invalid value for "amount", must be smaller than or equal to 1000000000.')
      end
      ...
      if !@expense_application_line_template_id.nil? && @expense_application_line_template_id > 999999999999
        invalid_properties.push('invalid value for "expense_application_line_template_id", must be smaller than or equal to 999999999999.')
      end

      if !@expense_application_line_template_id.nil? && @expense_application_line_template_id < 1
        invalid_properties.push('invalid value for "expense_application_line_template_id", must be greater than or equal to 1.')
      end

      if !@receipt_id.nil? && @receipt_id > 999999999999
        invalid_properties.push('invalid value for "receipt_id", must be smaller than or equal to 999999999999.')
      end
    ...
    def valid?
      ...
      return false if !@amount.nil? && @amount > 1000000000
      return false if !@amount.nil? && @amount < 0
      return false if !@expense_application_line_template_id.nil? && @expense_application_line_template_id > 999999999999
      return false if !@expense_application_line_template_id.nil? && @expense_application_line_template_id < 1
      return false if !@receipt_id.nil? && @receipt_id > 999999999999
    ...
    def amount=(amount)
      if !amount.nil? && amount > 1000000000
        fail ArgumentError, 'invalid value for "amount", must be smaller than or equal to 1000000000.'
      end
    ...
    # Custom attribute writer method with validation
    # @param [Object] expense_application_line_template_id Value to be assigned
    def expense_application_line_template_id=(expense_application_line_template_id)
      if !expense_application_line_template_id.nil? && expense_application_line_template_id > 999999999999
        fail ArgumentError, 'invalid value for "expense_application_line_template_id", must be smaller than or equal to 999999999999.'
      end

      if !expense_application_line_template_id.nil? && expense_application_line_template_id < 1
        fail ArgumentError, 'invalid value for "expense_application_line_template_id", must be greater than or equal to 1.'
      end
    ...
    def receipt_id=(receipt_id)
      if !receipt_id.nil? && receipt_id > 999999999999
        fail ArgumentError, 'invalid value for "receipt_id", must be smaller than or equal to 999999999999.'
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          amount == o.amount &&
          expense_application_line_template_id == o.expense_application_line_template_id &&
    ...
    def hash
      [id, transaction_date, description, amount, expense_application_line_template_id, receipt_id].hash
    end
