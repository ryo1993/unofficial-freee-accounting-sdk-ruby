...
module UnofficialFreeeSdk
  class ManualJournalResponse
    attr_accessor :manual_journal
    ...
    def self.openapi_types
      {
        :'manual_journal' => :'ManualJournalResponseManualJournal'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `UnofficialFreeeSdk::ManualJournalResponse` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `UnofficialFreeeSdk::ManualJournalResponse`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'manual_journal')
        self.manual_journal = attributes[:'manual_journal']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @manual_journal.nil?
        invalid_properties.push('invalid value for "manual_journal", manual_journal cannot be nil.')
      end
    ...
    def valid?
      return false if @manual_journal.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          manual_journal == o.manual_journal
    end
