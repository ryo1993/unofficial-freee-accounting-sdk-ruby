...
module UnofficialFreeeSdk
  class AccountItemParams
    # 事業所ID
    attr_accessor :company_id

    attr_accessor :account_item
    ...
    def self.openapi_types
      {
        :'company_id' => :'Integer',
        :'account_item' => :'AccountItemParamsAccountItem'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `UnofficialFreeeSdk::AccountItemParams` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `UnofficialFreeeSdk::AccountItemParams`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'account_item')
        self.account_item = attributes[:'account_item']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @account_item.nil?
        invalid_properties.push('invalid value for "account_item", account_item cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @account_item.nil?
      true
    end
