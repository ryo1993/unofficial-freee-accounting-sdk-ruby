...
module UnofficialFreeeSdk
  class TrialPlSectionsResponse
    attr_accessor :trial_pl_sections
    ...
    def self.openapi_types
      {
        :'trial_pl_sections' => :'TrialPlSectionsResponseTrialPlSections'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `UnofficialFreeeSdk::TrialPlSectionsResponse` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `UnofficialFreeeSdk::TrialPlSectionsResponse`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'trial_pl_sections')
        self.trial_pl_sections = attributes[:'trial_pl_sections']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @trial_pl_sections.nil?
        invalid_properties.push('invalid value for "trial_pl_sections", trial_pl_sections cannot be nil.')
      end
    ...
    def valid?
      return false if @trial_pl_sections.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          trial_pl_sections == o.trial_pl_sections
    end
