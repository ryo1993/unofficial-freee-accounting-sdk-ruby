...
module UnofficialFreeeSdk
  class PartnerCreateParamsPartnerBankAccountAttributes
    # 銀行名
    ...
    # 受取人名
    attr_accessor :long_account_name
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `UnofficialFreeeSdk::PartnerCreateParamsPartnerBankAccountAttributes` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `UnofficialFreeeSdk::PartnerCreateParamsPartnerBankAccountAttributes`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'branch_kana')
        self.branch_kana = attributes[:'branch_kana']
      end
      ...
      if attributes.key?(:'long_account_name')
        self.long_account_name = attributes[:'long_account_name']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          branch_kana == o.branch_kana &&
          branch_code == o.branch_code &&
          account_type == o.account_type &&
          account_number == o.account_number &&
          long_account_name == o.long_account_name &&
    ...
    def hash
      [bank_name, bank_name_kana, bank_code, branch_name, branch_kana, branch_code, account_type, account_number, long_account_name, account_name].hash
    end
