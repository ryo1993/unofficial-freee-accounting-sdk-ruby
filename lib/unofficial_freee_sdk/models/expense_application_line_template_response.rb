...
module UnofficialFreeeSdk
  class ExpenseApplicationLineTemplateResponse
    attr_accessor :expense_application_line_template
    ...
    def self.openapi_types
      {
        :'expense_application_line_template' => :'ExpenseApplicationLineTemplateResponseExpenseApplicationLineTemplate'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `UnofficialFreeeSdk::ExpenseApplicationLineTemplateResponse` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `UnofficialFreeeSdk::ExpenseApplicationLineTemplateResponse`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'expense_application_line_template')
        self.expense_application_line_template = attributes[:'expense_application_line_template']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @expense_application_line_template.nil?
        invalid_properties.push('invalid value for "expense_application_line_template", expense_application_line_template cannot be nil.')
      end
    ...
    def valid?
      return false if @expense_application_line_template.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          expense_application_line_template == o.expense_application_line_template
    end
    ...
    def hash
      [expense_application_line_template].hash
    end
