...
module UnofficialFreeeSdk
  class TrialPlResponseTrialPlBalances
    # 勘定科目ID(勘定科目の時のみ含まれる)
    ...
    def self.openapi_types
      {
        ...
        :'partners' => :'Array<TrialBsResponseTrialBsPartners>',
        :'items' => :'Array<TrialBsResponseTrialBsItems>',
        :'sections' => :'Array<TrialPlResponseTrialPlSections>',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `UnofficialFreeeSdk::TrialPlResponseTrialPlBalances` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `UnofficialFreeeSdk::TrialPlResponseTrialPlBalances`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'composition_ratio')
        self.composition_ratio = attributes[:'composition_ratio']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          composition_ratio == o.composition_ratio
    end
    ...
    def hash
      [account_item_id, account_item_name, partners, items, sections, account_category_id, account_category_name, total_line, hierarchy_level, parent_account_category_id, parent_account_category_name, opening_balance, debit_amount, credit_amount, closing_balance, composition_ratio].hash
    end
