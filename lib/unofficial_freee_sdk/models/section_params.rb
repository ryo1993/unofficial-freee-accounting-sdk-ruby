  ...
  class SectionParams
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `UnofficialFreeeSdk::SectionParams` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `UnofficialFreeeSdk::SectionParams`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def list_invalid_properties
      ...
      if !@shortcut1.nil? && @shortcut1.to_s.length > 20
        invalid_properties.push('invalid value for "shortcut1", the character length must be smaller than or equal to 20.')
      end

      if !@shortcut2.nil? && @shortcut2.to_s.length > 20
        invalid_properties.push('invalid value for "shortcut2", the character length must be smaller than or equal to 20.')
      end

      if !@parent_id.nil? && @parent_id > 999999999999
        invalid_properties.push('invalid value for "parent_id", must be smaller than or equal to 999999999999.')
      end
    ...
    def valid?
      ...
      return false if !@shortcut1.nil? && @shortcut1.to_s.length > 20
      return false if !@shortcut2.nil? && @shortcut2.to_s.length > 20
      return false if !@parent_id.nil? && @parent_id > 999999999999
    ...
    def shortcut1=(shortcut1)
      if !shortcut1.nil? && shortcut1.to_s.length > 20
        fail ArgumentError, 'invalid value for "shortcut1", the character length must be smaller than or equal to 20.'
      end
    ...
    def shortcut2=(shortcut2)
      if !shortcut2.nil? && shortcut2.to_s.length > 20
        fail ArgumentError, 'invalid value for "shortcut2", the character length must be smaller than or equal to 20.'
      end
    ...
    def parent_id=(parent_id)
      if !parent_id.nil? && parent_id > 999999999999
        fail ArgumentError, 'invalid value for "parent_id", must be smaller than or equal to 999999999999.'
      end
    ...
    def hash
      [company_id, name, long_name, shortcut1, shortcut2, parent_id].hash
    end
