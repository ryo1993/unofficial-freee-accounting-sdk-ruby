...
module UnofficialFreeeSdk
  class SelectablesIndexResponse
    attr_accessor :account_categories
    ...
    def self.openapi_types
      {
        :'account_categories' => :'Array<SelectablesIndexResponseAccountCategories>',
        :'account_groups' => :'Array<SelectablesIndexResponseAccountGroups>'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `UnofficialFreeeSdk::SelectablesIndexResponse` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `UnofficialFreeeSdk::SelectablesIndexResponse`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'account_categories')
        if (value = attributes[:'account_categories']).is_a?(Array)
          self.account_categories = value
        end
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          account_categories == o.account_categories &&
    ...
    def hash
      [account_categories, account_groups].hash
    end
