...
module UnofficialFreeeSdk
  class ExpenseApplicationResponse
    attr_accessor :expense_application
    ...
    def self.openapi_types
      {
        :'expense_application' => :'ExpenseApplicationResponseExpenseApplication'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `UnofficialFreeeSdk::ExpenseApplicationResponse` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `UnofficialFreeeSdk::ExpenseApplicationResponse`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'expense_application')
        self.expense_application = attributes[:'expense_application']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @expense_application.nil?
        invalid_properties.push('invalid value for "expense_application", expense_application cannot be nil.')
      end
    ...
    def valid?
      return false if @expense_application.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          expense_application == o.expense_application
    end
