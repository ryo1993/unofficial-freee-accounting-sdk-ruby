...
module UnofficialFreeeSdk
  class CompanyResponseCompany
    ...
    attr_accessor :use_partner_code
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `UnofficialFreeeSdk::CompanyResponseCompany` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `UnofficialFreeeSdk::CompanyResponseCompany`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'use_partner_code')
        self.use_partner_code = attributes[:'use_partner_code']
      end
    ...
    def list_invalid_properties
      ...
      if @use_partner_code.nil?
        invalid_properties.push('invalid value for "use_partner_code", use_partner_code cannot be nil.')
      end

      if @fiscal_years.nil?
        invalid_properties.push('invalid value for "fiscal_years", fiscal_years cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @use_partner_code.nil?
      return false if @fiscal_years.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          use_partner_code == o.use_partner_code &&
    ...
    def hash
      [id, name, name_kana, display_name, tax_at_source_calc_type, contact_name, head_count, corporate_number, txn_number_format, default_wallet_account_id, private_settlement, minus_format, role, phone1, phone2, fax, zipcode, prefecture_code, street_name1, street_name2, invoice_layout, invoice_style, amount_fraction, industry_class, industry_code, workflow_setting, use_partner_code, fiscal_years].hash
    end
