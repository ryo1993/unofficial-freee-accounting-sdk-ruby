...
module UnofficialFreeeSdk
  class SelectablesIndexResponseAccountGroups
    # 決算書表示名（小カテゴリー）ID
    attr_accessor :id
    ...
    # 年度ID
    attr_accessor :account_structure_id
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `UnofficialFreeeSdk::SelectablesIndexResponseAccountGroups` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `UnofficialFreeeSdk::SelectablesIndexResponseAccountGroups`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'account_structure_id')
        self.account_structure_id = attributes[:'account_structure_id']
      end
      ...
      if attributes.key?(:'detail_type')
        self.detail_type = attributes[:'detail_type']
      end
    ...
    def list_invalid_properties
      ...
      if @account_structure_id.nil?
        invalid_properties.push('invalid value for "account_structure_id", account_structure_id cannot be nil.')
      end

      if @account_structure_id > 999999999999
        invalid_properties.push('invalid value for "account_structure_id", must be smaller than or equal to 999999999999.')
      end

      if @account_structure_id < 1
        invalid_properties.push('invalid value for "account_structure_id", must be greater than or equal to 1.')
      end
      ...
      if !@detail_type.nil? && @detail_type > 4
        invalid_properties.push('invalid value for "detail_type", must be smaller than or equal to 4.')
      end

      if !@detail_type.nil? && @detail_type < 0
        invalid_properties.push('invalid value for "detail_type", must be greater than or equal to 0.')
      end
    ...
    def valid?
      ...
      return false if @account_structure_id.nil?
      return false if @account_structure_id > 999999999999
      return false if @account_structure_id < 1
      ...
      return false if !@detail_type.nil? && @detail_type > 4
      return false if !@detail_type.nil? && @detail_type < 0
    ...
    # Custom attribute writer method with validation
    # @param [Object] account_structure_id Value to be assigned
    def account_structure_id=(account_structure_id)
      if account_structure_id.nil?
        fail ArgumentError, 'account_structure_id cannot be nil'
      end

      if account_structure_id > 999999999999
        fail ArgumentError, 'invalid value for "account_structure_id", must be smaller than or equal to 999999999999.'
      end

      if account_structure_id < 1
        fail ArgumentError, 'invalid value for "account_structure_id", must be greater than or equal to 1.'
      end
    ...
    # Custom attribute writer method with validation
    # @param [Object] detail_type Value to be assigned
    def detail_type=(detail_type)
      if !detail_type.nil? && detail_type > 4
        fail ArgumentError, 'invalid value for "detail_type", must be smaller than or equal to 4.'
      end

      if !detail_type.nil? && detail_type < 0
        fail ArgumentError, 'invalid value for "detail_type", must be greater than or equal to 0.'
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          id == o.id &&
          name == o.name &&
          account_structure_id == o.account_structure_id &&
          account_category_id == o.account_category_id &&
          detail_type == o.detail_type &&
          index == o.index &&
    ...
    def hash
      [id, name, account_structure_id, account_category_id, detail_type, index, created_at, updated_at].hash
    end
