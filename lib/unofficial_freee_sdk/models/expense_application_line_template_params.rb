...
module UnofficialFreeeSdk
  class ExpenseApplicationLineTemplateParams
    # 事業所ID
    ...
    # 勘定科目ID
    attr_accessor :account_items_id
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `UnofficialFreeeSdk::ExpenseApplicationLineTemplateParams` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `UnofficialFreeeSdk::ExpenseApplicationLineTemplateParams`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'account_items_id')
        self.account_items_id = attributes[:'account_items_id']
      end
      ...
      if attributes.key?(:'line_description')
        self.line_description = attributes[:'line_description']
      end
    end
    ...
    def list_invalid_properties
      ...
      if !@account_items_id.nil? && @account_items_id > 999999999999
        invalid_properties.push('invalid value for "account_items_id", must be smaller than or equal to 999999999999.')
      end

      if !@account_items_id.nil? && @account_items_id < 1
        invalid_properties.push('invalid value for "account_items_id", must be greater than or equal to 1.')
      end
      ...
      if !@line_description.nil? && @line_description.to_s.length > 1000
        invalid_properties.push('invalid value for "line_description", the character length must be smaller than or equal to 1000.')
      end
    ...
    def valid?
      ...
      return false if !@account_items_id.nil? && @account_items_id > 999999999999
      return false if !@account_items_id.nil? && @account_items_id < 1
      ...
      return false if !@line_description.nil? && @line_description.to_s.length > 1000
      true
    end
    ...
    # Custom attribute writer method with validation
    # @param [Object] account_items_id Value to be assigned
    def account_items_id=(account_items_id)
      if !account_items_id.nil? && account_items_id > 999999999999
        fail ArgumentError, 'invalid value for "account_items_id", must be smaller than or equal to 999999999999.'
      end

      if !account_items_id.nil? && account_items_id < 1
        fail ArgumentError, 'invalid value for "account_items_id", must be greater than or equal to 1.'
      end
    ...
    # Custom attribute writer method with validation
    # @param [Object] line_description Value to be assigned
    def line_description=(line_description)
      if !line_description.nil? && line_description.to_s.length > 1000
        fail ArgumentError, 'invalid value for "line_description", the character length must be smaller than or equal to 1000.'
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          name == o.name &&
          account_items_id == o.account_items_id &&
          item_id == o.item_id &&
          tax_code == o.tax_code &&
          description == o.description &&
          line_description == o.line_description
    end
    ...
    def hash
      [company_id, name, account_items_id, item_id, tax_code, description, line_description].hash
    end
