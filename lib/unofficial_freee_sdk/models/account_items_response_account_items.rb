...
module UnofficialFreeeSdk
  class AccountItemsResponseAccountItems
    # 勘定科目ID
    attr_accessor :id
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `UnofficialFreeeSdk::AccountItemsResponseAccountItems` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `UnofficialFreeeSdk::AccountItemsResponseAccountItems`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'default_tax_id')
        self.default_tax_id = attributes[:'default_tax_id']
      end
    ...
    def list_invalid_properties
      ...
      if !@default_tax_id.nil? && @default_tax_id > 999999999999
        invalid_properties.push('invalid value for "default_tax_id", must be smaller than or equal to 999999999999.')
      end

      if !@default_tax_id.nil? && @default_tax_id < 1
        invalid_properties.push('invalid value for "default_tax_id", must be greater than or equal to 1.')
      end

      if @default_tax_code.nil?
        invalid_properties.push('invalid value for "default_tax_code", default_tax_code cannot be nil.')
      end

      if @default_tax_code > 999999999999
        invalid_properties.push('invalid value for "default_tax_code", must be smaller than or equal to 999999999999.')
      end

      if @default_tax_code < 0
        invalid_properties.push('invalid value for "default_tax_code", must be greater than or equal to 0.')
      end
    ...
    def valid?
      ...
      return false if !@default_tax_id.nil? && @default_tax_id > 999999999999
      return false if !@default_tax_id.nil? && @default_tax_id < 1
      return false if @default_tax_code.nil?
      return false if @default_tax_code > 999999999999
      return false if @default_tax_code < 0
    ...
    # Custom attribute writer method with validation
    # @param [Object] default_tax_id Value to be assigned
    def default_tax_id=(default_tax_id)
      if !default_tax_id.nil? && default_tax_id > 999999999999
        fail ArgumentError, 'invalid value for "default_tax_id", must be smaller than or equal to 999999999999.'
      end

      if !default_tax_id.nil? && default_tax_id < 1
        fail ArgumentError, 'invalid value for "default_tax_id", must be greater than or equal to 1.'
      end
    ...
    # Custom attribute writer method with validation
    # @param [Object] default_tax_code Value to be assigned
    def default_tax_code=(default_tax_code)
      if default_tax_code.nil?
        fail ArgumentError, 'default_tax_code cannot be nil'
      end

      if default_tax_code > 999999999999
        fail ArgumentError, 'invalid value for "default_tax_code", must be smaller than or equal to 999999999999.'
      end

      if default_tax_code < 0
        fail ArgumentError, 'invalid value for "default_tax_code", must be greater than or equal to 0.'
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          default_tax_id == o.default_tax_id &&
    ...
    def hash
      [id, name, shortcut, shortcut_num, default_tax_id, default_tax_code, categories, available, walletable_id, group_name, corresponding_income_name, corresponding_income_id, corresponding_expense_name, corresponding_expense_id].hash
    end
