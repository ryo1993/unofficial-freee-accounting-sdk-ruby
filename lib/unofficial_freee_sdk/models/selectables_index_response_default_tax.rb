...
module UnofficialFreeeSdk
  class SelectablesIndexResponseDefaultTax
    attr_accessor :tax_rate_5

    attr_accessor :tax_rate_8
    ...
    def self.openapi_types
      {
        :'tax_rate_5' => :'SelectablesIndexResponseDefaultTaxTaxRate5',
        :'tax_rate_8' => :'SelectablesIndexResponseDefaultTaxTaxRate8'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `UnofficialFreeeSdk::SelectablesIndexResponseDefaultTax` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `UnofficialFreeeSdk::SelectablesIndexResponseDefaultTax`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'tax_rate_5')
        self.tax_rate_5 = attributes[:'tax_rate_5']
      end

      if attributes.key?(:'tax_rate_8')
        self.tax_rate_8 = attributes[:'tax_rate_8']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          tax_rate_5 == o.tax_rate_5 &&
          tax_rate_8 == o.tax_rate_8
    end
