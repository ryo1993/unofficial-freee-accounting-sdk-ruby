...
module UnofficialFreeeSdk
  class ExpenseApplicationResponseExpenseApplication
    # 経費申請ID
    attr_accessor :id
    ...
    # 経費申請の項目行一覧（配列）
    attr_accessor :expense_application_lines
    ...
    def self.openapi_types
      {
        ...
        :'expense_application_lines' => :'Array<ExpenseApplicationResponseExpenseApplicationExpenseApplicationLines>'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `UnofficialFreeeSdk::ExpenseApplicationResponseExpenseApplication` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `UnofficialFreeeSdk::ExpenseApplicationResponseExpenseApplication`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'editable_on_web')
        self.editable_on_web = attributes[:'editable_on_web']
      end
      ...
      if attributes.key?(:'expense_application_lines')
        if (value = attributes[:'expense_application_lines']).is_a?(Array)
          self.expense_application_lines = value
        end
      end
    end
    ...
    def list_invalid_properties
      ...
      if @editable_on_web.nil?
        invalid_properties.push('invalid value for "editable_on_web", editable_on_web cannot be nil.')
      end
      ...
      if @expense_application_lines.nil?
        invalid_properties.push('invalid value for "expense_application_lines", expense_application_lines cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @editable_on_web.nil?
      ...
      return false if @expense_application_lines.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          editable_on_web == o.editable_on_web &&
          total_amount == o.total_amount &&
          status == o.status &&
          section_id == o.section_id &&
          tag_ids == o.tag_ids &&
          expense_application_lines == o.expense_application_lines
    end
    ...
    def hash
      [id, company_id, title, issue_date, description, editable_on_web, total_amount, status, section_id, tag_ids, expense_application_lines].hash
    end
