...
module UnofficialFreeeSdk
  class WalletableResponse
    attr_accessor :walletable
    ...
    def self.openapi_types
      {
        :'walletable' => :'WalletableResponseWalletable'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `UnofficialFreeeSdk::WalletableResponse` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `UnofficialFreeeSdk::WalletableResponse`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'walletable')
        self.walletable = attributes[:'walletable']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @walletable.nil?
        invalid_properties.push('invalid value for "walletable", walletable cannot be nil.')
      end
    ...
    def valid?
      return false if @walletable.nil?
      true
    end
