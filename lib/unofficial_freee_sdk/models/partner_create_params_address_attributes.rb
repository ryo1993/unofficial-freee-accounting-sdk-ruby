...
module UnofficialFreeeSdk
  class PartnerCreateParamsAddressAttributes
    # 郵便番号（8文字以内）
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `UnofficialFreeeSdk::PartnerCreateParamsAddressAttributes` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `UnofficialFreeeSdk::PartnerCreateParamsAddressAttributes`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def list_invalid_properties
      ...
      if !@zipcode.nil? && @zipcode.to_s.length > 8
        invalid_properties.push('invalid value for "zipcode", the character length must be smaller than or equal to 8.')
      end

      if !@prefecture_code.nil? && @prefecture_code > 46
        invalid_properties.push('invalid value for "prefecture_code", must be smaller than or equal to 46.')
      end

      if !@prefecture_code.nil? && @prefecture_code < 0
        invalid_properties.push('invalid value for "prefecture_code", must be greater than or equal to 0.')
      end

      if !@street_name1.nil? && @street_name1.to_s.length > 255
        invalid_properties.push('invalid value for "street_name1", the character length must be smaller than or equal to 255.')
      end

      if !@street_name2.nil? && @street_name2.to_s.length > 255
        invalid_properties.push('invalid value for "street_name2", the character length must be smaller than or equal to 255.')
      end
    ...
    def valid?
      return false if !@zipcode.nil? && @zipcode.to_s.length > 8
      return false if !@prefecture_code.nil? && @prefecture_code > 46
      return false if !@prefecture_code.nil? && @prefecture_code < 0
      return false if !@street_name1.nil? && @street_name1.to_s.length > 255
      return false if !@street_name2.nil? && @street_name2.to_s.length > 255
      true
    end
    ...
    def zipcode=(zipcode)
      if !zipcode.nil? && zipcode.to_s.length > 8
        fail ArgumentError, 'invalid value for "zipcode", the character length must be smaller than or equal to 8.'
      end
    ...
    # Custom attribute writer method with validation
    # @param [Object] street_name1 Value to be assigned
    def street_name1=(street_name1)
      if !street_name1.nil? && street_name1.to_s.length > 255
        fail ArgumentError, 'invalid value for "street_name1", the character length must be smaller than or equal to 255.'
      end
    ...
    # Custom attribute writer method with validation
    # @param [Object] street_name2 Value to be assigned
    def street_name2=(street_name2)
      if !street_name2.nil? && street_name2.to_s.length > 255
        fail ArgumentError, 'invalid value for "street_name2", the character length must be smaller than or equal to 255.'
      end
    ...
    def hash
      [zipcode, prefecture_code, street_name1, street_name2].hash
    end
