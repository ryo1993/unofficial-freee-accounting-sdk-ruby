...
module UnofficialFreeeSdk
  class InlineResponse20011Taxes
    # 税区分コード
    attr_accessor :code
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `UnofficialFreeeSdk::InlineResponse20011Taxes` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `UnofficialFreeeSdk::InlineResponse20011Taxes`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'display_category')
        self.display_category = attributes[:'display_category']
      end
    ...
    def list_invalid_properties
      ...
      if @code > 999999999999
        invalid_properties.push('invalid value for "code", must be smaller than or equal to 999999999999.')
      end
    ...
    def valid?
      ...
      return false if @code > 999999999999
      return false if @code < 0
      return false if @name.nil?
      return false if @name_ja.nil?
      display_category_validator = EnumAttributeValidator.new('String', ["tax_5", "tax_8", "tax_r8", "tax_10"])
      return false unless display_category_validator.valid?(@display_category)
    ...
    def code=(code)
      ...
      if code > 999999999999
        fail ArgumentError, 'invalid value for "code", must be smaller than or equal to 999999999999.'
      end
    ...
    # @param [Object] display_category Object to be assigned
    def display_category=(display_category)
      validator = EnumAttributeValidator.new('String', ["tax_5", "tax_8", "tax_r8", "tax_10"])
      unless validator.valid?(display_category)
        fail ArgumentError, "invalid value for \"display_category\", must be one of #{validator.allowable_values}."
      end
      @display_category = display_category
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          name == o.name &&
          name_ja == o.name_ja &&
          display_category == o.display_category &&
    ...
    def hash
      [code, name, name_ja, display_category, available].hash
    end
