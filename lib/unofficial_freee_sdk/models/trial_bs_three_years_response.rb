...
module UnofficialFreeeSdk
  class TrialBsThreeYearsResponse
    attr_accessor :trial_bs_three_years
    ...
    def self.openapi_types
      {
        :'trial_bs_three_years' => :'TrialBsThreeYearsResponseTrialBsThreeYears'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `UnofficialFreeeSdk::TrialBsThreeYearsResponse` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `UnofficialFreeeSdk::TrialBsThreeYearsResponse`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'trial_bs_three_years')
        self.trial_bs_three_years = attributes[:'trial_bs_three_years']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @trial_bs_three_years.nil?
        invalid_properties.push('invalid value for "trial_bs_three_years", trial_bs_three_years cannot be nil.')
      end
    ...
    def valid?
      return false if @trial_bs_three_years.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          trial_bs_three_years == o.trial_bs_three_years
    end
