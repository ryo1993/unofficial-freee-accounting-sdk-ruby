...
module UnofficialFreeeSdk
  class InlineResponse20018
    attr_accessor :expense_application_line_templates
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `UnofficialFreeeSdk::InlineResponse20018` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `UnofficialFreeeSdk::InlineResponse20018`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'expense_application_line_templates')
        if (value = attributes[:'expense_application_line_templates']).is_a?(Array)
          self.expense_application_line_templates = value
        end
      end
    end
    ...
    def list_invalid_properties
      ...
      if @expense_application_line_templates.nil?
        invalid_properties.push('invalid value for "expense_application_line_templates", expense_application_line_templates cannot be nil.')
      end
    ...
    def valid?
      return false if @expense_application_line_templates.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          expense_application_line_templates == o.expense_application_line_templates
    end
    ...
    def hash
      [expense_application_line_templates].hash
    end
