...
module UnofficialFreeeSdk
  class ApprovalRequestResponseApprovalRequest
    # 各種申請ID
    attr_accessor :id
    ...
    def self.openapi_types
      {
        ...
        :'status' => :'String',
        :'request_items' => :'Array<ApprovalRequestResponseApprovalRequestRequestItems>'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `UnofficialFreeeSdk::ApprovalRequestResponseApprovalRequest` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `UnofficialFreeeSdk::ApprovalRequestResponseApprovalRequest`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def list_invalid_properties
      ...
      if @application_date.nil?
        invalid_properties.push('invalid value for "application_date", application_date cannot be nil.')
      end
      ...
      if @applicant_id > 999999999999
        invalid_properties.push('invalid value for "applicant_id", must be smaller than or equal to 999999999999.')
      end

      if @applicant_id < 1
        invalid_properties.push('invalid value for "applicant_id", must be greater than or equal to 1.')
      end

      if @approver_id > 999999999999
      ...
      if @application_number.nil?
        invalid_properties.push('invalid value for "application_number", application_number cannot be nil.')
      end
      ...
      if @request_items.nil?
        invalid_properties.push('invalid value for "request_items", request_items cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @applicant_id > 999999999999
      return false if @applicant_id < 1
      return false if @approver_id > 999999999999
      return false if @approver_id < 1
      return false if @application_number.nil?
      return false if @status.nil?
      status_validator = EnumAttributeValidator.new('String', ["draft"])
      return false unless status_validator.valid?(@status)
      return false if @request_items.nil?
      true
    end
    ...
    # Custom attribute writer method with validation
    # @param [Object] applicant_id Value to be assigned
    def applicant_id=(applicant_id)
      if applicant_id.nil?
        fail ArgumentError, 'applicant_id cannot be nil'
      end

      if applicant_id > 999999999999
        fail ArgumentError, 'invalid value for "applicant_id", must be smaller than or equal to 999999999999.'
      end

      if applicant_id < 1
        fail ArgumentError, 'invalid value for "applicant_id", must be greater than or equal to 1.'
      end
    ...
    def hash
      [id, company_id, application_date, title, applicant_id, approver_id, application_number, status, request_items].hash
    end
