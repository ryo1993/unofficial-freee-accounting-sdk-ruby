...
module UnofficialFreeeSdk
  class SegmentTagResponse
    attr_accessor :segment_tag
    ...
    def self.openapi_types
      {
        :'segment_tag' => :'SegmentTagResponseSegmentTag'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `UnofficialFreeeSdk::SegmentTagResponse` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `UnofficialFreeeSdk::SegmentTagResponse`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'segment_tag')
        self.segment_tag = attributes[:'segment_tag']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @segment_tag.nil?
        invalid_properties.push('invalid value for "segment_tag", segment_tag cannot be nil.')
      end
    ...
    def valid?
      return false if @segment_tag.nil?
      true
    end
