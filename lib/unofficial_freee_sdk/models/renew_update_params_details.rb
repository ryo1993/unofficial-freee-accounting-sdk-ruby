...
module UnofficialFreeeSdk
  class RenewUpdateParamsDetails
    # 勘定科目ID
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `UnofficialFreeeSdk::RenewUpdateParamsDetails` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `UnofficialFreeeSdk::RenewUpdateParamsDetails`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def list_invalid_properties
      ...
      if !@vat.nil? && @vat > 999999999999
        invalid_properties.push('invalid value for "vat", must be smaller than or equal to 999999999999.')
      end

      if !@vat.nil? && @vat < -999999999999
        invalid_properties.push('invalid value for "vat", must be greater than or equal to -999999999999.')
      end
      ...
      if !@segment_1_tag_id.nil? && @segment_1_tag_id < 0
        invalid_properties.push('invalid value for "segment_1_tag_id", must be greater than or equal to 0.')
      end
      ...
      if !@segment_2_tag_id.nil? && @segment_2_tag_id < 0
        invalid_properties.push('invalid value for "segment_2_tag_id", must be greater than or equal to 0.')
      end
      ...
      if !@segment_3_tag_id.nil? && @segment_3_tag_id < 0
        invalid_properties.push('invalid value for "segment_3_tag_id", must be greater than or equal to 0.')
      end
    ...
    def valid?
      ...
      return false if @amount < -999999999999
      return false if !@vat.nil? && @vat > 999999999999
      return false if !@vat.nil? && @vat < -999999999999
      ...
      return false if !@segment_1_tag_id.nil? && @segment_1_tag_id < 0
      return false if !@segment_2_tag_id.nil? && @segment_2_tag_id > 999999999999
      return false if !@segment_2_tag_id.nil? && @segment_2_tag_id < 0
      return false if !@segment_3_tag_id.nil? && @segment_3_tag_id > 999999999999
      return false if !@segment_3_tag_id.nil? && @segment_3_tag_id < 0
      true
    end
    ...
    def vat=(vat)
      if !vat.nil? && vat > 999999999999
        fail ArgumentError, 'invalid value for "vat", must be smaller than or equal to 999999999999.'
      end

      if !vat.nil? && vat < -999999999999
        fail ArgumentError, 'invalid value for "vat", must be greater than or equal to -999999999999.'
      end
    ...
    def segment_1_tag_id=(segment_1_tag_id)
      ...
      if !segment_1_tag_id.nil? && segment_1_tag_id < 0
        fail ArgumentError, 'invalid value for "segment_1_tag_id", must be greater than or equal to 0.'
      end
    ...
    def segment_2_tag_id=(segment_2_tag_id)
      ...
      if !segment_2_tag_id.nil? && segment_2_tag_id < 0
        fail ArgumentError, 'invalid value for "segment_2_tag_id", must be greater than or equal to 0.'
      end
    ...
    def segment_3_tag_id=(segment_3_tag_id)
      ...
      if !segment_3_tag_id.nil? && segment_3_tag_id < 0
        fail ArgumentError, 'invalid value for "segment_3_tag_id", must be greater than or equal to 0.'
      end
    ...
    def hash
      [account_item_id, tax_code, amount, vat, item_id, section_id, tag_ids, segment_1_tag_id, segment_2_tag_id, segment_3_tag_id, description].hash
    end
