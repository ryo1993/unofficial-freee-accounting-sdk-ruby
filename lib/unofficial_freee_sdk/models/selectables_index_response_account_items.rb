...
module UnofficialFreeeSdk
  class SelectablesIndexResponseAccountItems
    # 勘定科目ID
    attr_accessor :id
    ...
    def self.openapi_types
      {
        ...
        :'help' => :'String',
        :'shortcut' => :'String',
        :'default_tax' => :'SelectablesIndexResponseDefaultTax'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `UnofficialFreeeSdk::SelectablesIndexResponseAccountItems` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `UnofficialFreeeSdk::SelectablesIndexResponseAccountItems`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'default_tax')
        self.default_tax = attributes[:'default_tax']
      end
    end
    ...
    def hash
      [id, name, desc, help, shortcut, default_tax].hash
    end
