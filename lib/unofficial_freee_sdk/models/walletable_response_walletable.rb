...
module UnofficialFreeeSdk
  class WalletableResponseWalletable
    # 口座ID
    attr_accessor :id
    ...
    # 同期残高
    attr_accessor :last_balance

    # 登録残高
    attr_accessor :walletable_balance
    ...
    def self.openapi_types
      {
        ...
        :'walletable_balance' => :'Integer',
        :'meta' => :'InlineResponse20012Meta'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `UnofficialFreeeSdk::WalletableResponseWalletable` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `UnofficialFreeeSdk::WalletableResponseWalletable`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'last_balance')
        self.last_balance = attributes[:'last_balance']
      end

      if attributes.key?(:'walletable_balance')
        self.walletable_balance = attributes[:'walletable_balance']
      end
    ...
    def list_invalid_properties
      ...
      if @bank_id > 999999999999
        invalid_properties.push('invalid value for "bank_id", must be smaller than or equal to 999999999999.')
      end

      if @bank_id < 1
        invalid_properties.push('invalid value for "bank_id", must be greater than or equal to 1.')
      end
    ...
    def valid?
      ...
      return false if @bank_id > 999999999999
      return false if @bank_id < 1
      return false if @type.nil?
      type_validator = EnumAttributeValidator.new('String', ["bank_account", "credit_card", "wallet"])
    ...
    def bank_id=(bank_id)
      if bank_id > 999999999999
        fail ArgumentError, 'invalid value for "bank_id", must be smaller than or equal to 999999999999.'
      end

      if bank_id < 1
        fail ArgumentError, 'invalid value for "bank_id", must be greater than or equal to 1.'
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          bank_id == o.bank_id &&
          type == o.type &&
          last_balance == o.last_balance &&
          walletable_balance == o.walletable_balance &&
          meta == o.meta
    end
    ...
    def hash
      [id, name, bank_id, type, last_balance, walletable_balance, meta].hash
    end
