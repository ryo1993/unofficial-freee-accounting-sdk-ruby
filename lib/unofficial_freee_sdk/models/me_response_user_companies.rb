  ...
  class MeResponseUserCompanies
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `UnofficialFreeeSdk::MeResponseUserCompanies` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `UnofficialFreeeSdk::MeResponseUserCompanies`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'use_custom_role')
        self.use_custom_role = attributes[:'use_custom_role']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @use_custom_role.nil?
        invalid_properties.push('invalid value for "use_custom_role", use_custom_role cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @use_custom_role.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          role == o.role &&
          use_custom_role == o.use_custom_role
    end
    ...
    def hash
      [id, display_name, role, use_custom_role].hash
    end
