...
module UnofficialFreeeSdk
  class QuotationResponseQuotation
    # 見積書ID
    attr_accessor :id
    ...
    def self.openapi_types
      {
        ...
        :'quotation_contents' => :'Array<QuotationResponseQuotationQuotationContents>',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `UnofficialFreeeSdk::QuotationResponseQuotation` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `UnofficialFreeeSdk::QuotationResponseQuotation`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def list_invalid_properties
      ...
      if @quotation_number.nil?
        invalid_properties.push('invalid value for "quotation_number", quotation_number cannot be nil.')
      end
      ...
      if @quotation_status.nil?
        invalid_properties.push('invalid value for "quotation_status", quotation_status cannot be nil.')
      end
      ...
      if @quotation_layout.nil?
        invalid_properties.push('invalid value for "quotation_layout", quotation_layout cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @quotation_number.nil?
      return false if @total_amount.nil?
      return false if @quotation_status.nil?
      quotation_status_validator = EnumAttributeValidator.new('String', ["unsubmitted", "submitted", "all"])
      return false unless quotation_status_validator.valid?(@quotation_status)
      partner_title_validator = EnumAttributeValidator.new('String', ["御中", "様", "(空白)"])
      return false unless partner_title_validator.valid?(@partner_title)
      ...
      return false if @quotation_layout.nil?
      quotation_layout_validator = EnumAttributeValidator.new('String', ["default_classic", "standard_classic", "envelope_classic", "carried_forward_standard_classic", "carried_forward_envelope_classic", "default_modern", "standard_modern", "envelope_modern"])
    ...
    def quotation_status=(quotation_status)
      validator = EnumAttributeValidator.new('String', ["unsubmitted", "submitted", "all"])
    ...
    # Custom attribute writer method checking allowed values (enum).
    # @param [Object] partner_title Object to be assigned
    def partner_title=(partner_title)
      validator = EnumAttributeValidator.new('String', ["御中", "様", "(空白)"])
      unless validator.valid?(partner_title)
        fail ArgumentError, "invalid value for \"partner_title\", must be one of #{validator.allowable_values}."
      end
      @partner_title = partner_title
    end
    ...
    def hash
      [id, company_id, issue_date, partner_id, partner_code, quotation_number, title, total_amount, total_vat, sub_total, description, quotation_status, web_published_at, web_downloaded_at, web_confirmed_at, mail_sent_at, partner_name, partner_display_name, partner_title, partner_zipcode, partner_prefecture_code, partner_prefecture_name, partner_address1, partner_address2, partner_contact_info, company_name, company_zipcode, company_prefecture_code, company_prefecture_name, company_address1, company_address2, company_contact_info, message, notes, quotation_layout, tax_entry_method, quotation_contents, total_amount_per_vat_rate].hash
    end
