...
module UnofficialFreeeSdk
  class TrialPlThreeYearsResponseTrialPlThreeYearsBalances
    # 勘定科目ID(勘定科目の時のみ含まれる)
    attr_accessor :account_item_id

    # 勘定科目名(勘定科目の時のみ含まれる)
    attr_accessor :account_item_name
    ...
    attr_accessor :account_category_name

    # 合計行(勘定科目カテゴリー名の時のみ含まれる)
    attr_accessor :total_line

    # 階層レベル
    attr_accessor :hierarchy_level

    # 上位科目カテゴリーID(上層が存在する場合含まれる)
    attr_accessor :parent_account_category_id

    # 上位勘定科目カテゴリー名(上層が存在する場合含まれる)
    attr_accessor :parent_account_category_name

    # 前々年度期末残高
    attr_accessor :two_years_before_closing_balance

    # 前年度期末残高
    attr_accessor :last_year_closing_balance

    # 期末残高
    attr_accessor :closing_balance

    # 前年比
    attr_accessor :year_on_year
    ...
    def self.openapi_types
      {
        ...
        :'partners' => :'Array<TrialBsThreeYearsResponseTrialBsThreeYearsPartners>',
        :'items' => :'Array<TrialBsThreeYearsResponseTrialBsThreeYearsItems>',
        :'sections' => :'Array<TrialPlThreeYearsResponseTrialPlThreeYearsSections>',
        :'account_category_id' => :'Integer',
        :'account_category_name' => :'String',
        :'total_line' => :'Boolean',
        :'hierarchy_level' => :'Integer',
        :'parent_account_category_id' => :'Integer',
        :'parent_account_category_name' => :'String',
        :'two_years_before_closing_balance' => :'Integer',
        :'last_year_closing_balance' => :'Integer',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `UnofficialFreeeSdk::TrialPlThreeYearsResponseTrialPlThreeYearsBalances` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `UnofficialFreeeSdk::TrialPlThreeYearsResponseTrialPlThreeYearsBalances`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'account_item_name')
        self.account_item_name = attributes[:'account_item_name']
      end
      ...
      if attributes.key?(:'account_category_name')
        self.account_category_name = attributes[:'account_category_name']
      end

      if attributes.key?(:'total_line')
        self.total_line = attributes[:'total_line']
      end
      ...
      if attributes.key?(:'parent_account_category_id')
        self.parent_account_category_id = attributes[:'parent_account_category_id']
      end

      if attributes.key?(:'parent_account_category_name')
        self.parent_account_category_name = attributes[:'parent_account_category_name']
      end

      if attributes.key?(:'two_years_before_closing_balance')
        self.two_years_before_closing_balance = attributes[:'two_years_before_closing_balance']
      end

      if attributes.key?(:'last_year_closing_balance')
        self.last_year_closing_balance = attributes[:'last_year_closing_balance']
      end
      ...
      if attributes.key?(:'year_on_year')
        self.year_on_year = attributes[:'year_on_year']
      end
    end
    ...
    def list_invalid_properties
      ...
      if !@account_category_id.nil? && @account_category_id > 999999999999
        invalid_properties.push('invalid value for "account_category_id", must be smaller than or equal to 999999999999.')
      end

      if !@account_category_id.nil? && @account_category_id < 1
        invalid_properties.push('invalid value for "account_category_id", must be greater than or equal to 1.')
      end

      if !@parent_account_category_id.nil? && @parent_account_category_id > 999999999999
        invalid_properties.push('invalid value for "parent_account_category_id", must be smaller than or equal to 999999999999.')
      end

      if !@parent_account_category_id.nil? && @parent_account_category_id < 1
        invalid_properties.push('invalid value for "parent_account_category_id", must be greater than or equal to 1.')
      end
    ...
    def valid?
      ...
      return false if !@account_category_id.nil? && @account_category_id > 999999999999
      return false if !@account_category_id.nil? && @account_category_id < 1
      return false if !@parent_account_category_id.nil? && @parent_account_category_id > 999999999999
      return false if !@parent_account_category_id.nil? && @parent_account_category_id < 1
      true
    end
    ...
    # Custom attribute writer method with validation
    # @param [Object] parent_account_category_id Value to be assigned
    def parent_account_category_id=(parent_account_category_id)
      if !parent_account_category_id.nil? && parent_account_category_id > 999999999999
        fail ArgumentError, 'invalid value for "parent_account_category_id", must be smaller than or equal to 999999999999.'
      end

      if !parent_account_category_id.nil? && parent_account_category_id < 1
        fail ArgumentError, 'invalid value for "parent_account_category_id", must be greater than or equal to 1.'
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          account_item_name == o.account_item_name &&
          partners == o.partners &&
          items == o.items &&
          sections == o.sections &&
          account_category_id == o.account_category_id &&
          account_category_name == o.account_category_name &&
          total_line == o.total_line &&
          hierarchy_level == o.hierarchy_level &&
          parent_account_category_id == o.parent_account_category_id &&
          parent_account_category_name == o.parent_account_category_name &&
          two_years_before_closing_balance == o.two_years_before_closing_balance &&
          last_year_closing_balance == o.last_year_closing_balance &&
          closing_balance == o.closing_balance &&
          year_on_year == o.year_on_year
    end
    ...
    def hash
      [account_item_id, account_item_name, partners, items, sections, account_category_id, account_category_name, total_line, hierarchy_level, parent_account_category_id, parent_account_category_name, two_years_before_closing_balance, last_year_closing_balance, closing_balance, year_on_year].hash
    end
