...
module UnofficialFreeeSdk
  class ExpenseApplicationLineTemplateResponseExpenseApplicationLineTemplate
    # 経費科目ID
    attr_accessor :id
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `UnofficialFreeeSdk::ExpenseApplicationLineTemplateResponseExpenseApplicationLineTemplate` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `UnofficialFreeeSdk::ExpenseApplicationLineTemplateResponseExpenseApplicationLineTemplate`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def list_invalid_properties
      ...
      if @account_item_name.nil?
        invalid_properties.push('invalid value for "account_item_name", account_item_name cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @account_item_name.nil?
    ...
    def hash
      [id, name, account_item_id, account_item_name, tax_code, tax_name, description, line_description].hash
    end
