...
module UnofficialFreeeSdk
  class DealResponseDealReceipts
    # 証憑ID
    attr_accessor :id
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `UnofficialFreeeSdk::DealResponseDealReceipts` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `UnofficialFreeeSdk::DealResponseDealReceipts`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'file_src')
        self.file_src = attributes[:'file_src']
      end
    ...
    def list_invalid_properties
      ...
      if @file_src.nil?
        invalid_properties.push('invalid value for "file_src", file_src cannot be nil.')
      end
    ...
    def valid?
      ...
      status_validator = EnumAttributeValidator.new('String', ["unconfirmed", "confirmed", "deleted", "ignored"])
      return false unless status_validator.valid?(@status)
      return false if @mime_type.nil?
      return false if @origin.nil?
      origin_validator = EnumAttributeValidator.new('String', ["unknown", "web", "mobile_camera", "mobile_album", "scansnap", "scannable", "dropbox", "mail", "safety_contact_file", "public_api"])
      return false unless origin_validator.valid?(@origin)
      return false if @created_at.nil?
      return false if @file_src.nil?
    ...
    def status=(status)
      validator = EnumAttributeValidator.new('String', ["unconfirmed", "confirmed", "deleted", "ignored"])
    ...
    def origin=(origin)
      validator = EnumAttributeValidator.new('String', ["unknown", "web", "mobile_camera", "mobile_album", "scansnap", "scannable", "dropbox", "mail", "safety_contact_file", "public_api"])
    ...
    def hash
      [id, status, description, mime_type, issue_date, origin, created_at, file_src, user].hash
    end
