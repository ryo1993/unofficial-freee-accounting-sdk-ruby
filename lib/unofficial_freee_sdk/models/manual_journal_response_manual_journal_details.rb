...
module UnofficialFreeeSdk
  class ManualJournalResponseManualJournalDetails
    # 貸借行ID
    attr_accessor :id
    ...
    # セグメント１ID
    attr_accessor :segment_1_tag_name

    # セグメント２ID
    attr_accessor :segment_2_tag_id

    # セグメント２
    attr_accessor :segment_2_tag_name

    # セグメント３ID
    attr_accessor :segment_3_tag_id

    # セグメント３
    attr_accessor :segment_3_tag_name
    ...
    def self.openapi_types
      {
        ...
        :'segment_1_tag_name' => :'Integer',
        :'segment_2_tag_id' => :'Integer',
        :'segment_2_tag_name' => :'Integer',
        :'segment_3_tag_id' => :'Integer',
        :'segment_3_tag_name' => :'Integer',
        :'amount' => :'Integer',
        :'vat' => :'Integer',
        :'description' => :'String'
      }
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `UnofficialFreeeSdk::ManualJournalResponseManualJournalDetails` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `UnofficialFreeeSdk::ManualJournalResponseManualJournalDetails`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'segment_1_tag_name')
        self.segment_1_tag_name = attributes[:'segment_1_tag_name']
      end
      ...
      if attributes.key?(:'segment_2_tag_name')
        self.segment_2_tag_name = attributes[:'segment_2_tag_name']
      end
      ...
      if attributes.key?(:'segment_3_tag_name')
        self.segment_3_tag_name = attributes[:'segment_3_tag_name']
      end
    ...
    def list_invalid_properties
      ...
      if @partner_long_name.to_s.length > 255
        invalid_properties.push('invalid value for "partner_long_name", the character length must be smaller than or equal to 255.')
      end

      if @item_id > 999999999999
    ...
    def valid?
      ...
      return false if @partner_long_name.to_s.length > 255
      return false if @item_id > 999999999999
      return false if @item_id < 1
      return false if @section_id > 999999999999
      return false if @section_id < 1
    ...
    # Custom attribute writer method with validation
    # @param [Object] partner_long_name Value to be assigned
    def partner_long_name=(partner_long_name)
      if partner_long_name.to_s.length > 255
        fail ArgumentError, 'invalid value for "partner_long_name", the character length must be smaller than or equal to 255.'
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          segment_1_tag_name == o.segment_1_tag_name &&
          segment_2_tag_id == o.segment_2_tag_id &&
          segment_2_tag_name == o.segment_2_tag_name &&
          segment_3_tag_id == o.segment_3_tag_id &&
          segment_3_tag_name == o.segment_3_tag_name &&
          amount == o.amount &&
          vat == o.vat &&
    ...
    def hash
      [id, entry_side, account_item_id, tax_code, partner_id, partner_name, partner_code, partner_long_name, item_id, item_name, section_id, section_name, tag_ids, tag_names, segment_1_tag_id, segment_1_tag_name, segment_2_tag_id, segment_2_tag_name, segment_3_tag_id, segment_3_tag_name, amount, vat, description].hash
    end
