...
module UnofficialFreeeSdk
  class DealResponseDealRenews
    ...
    # +更新の対象行ID
    attr_accessor :renew_target_id

    # +更新の対象行タイプ
    attr_accessor :renew_target_type
    ...
    def self.openapi_types
      {
        :'id' => :'Integer',
        :'update_date' => :'String',
        :'renew_target_id' => :'Integer',
        :'renew_target_type' => :'String',
        :'details' => :'Array<DealResponseDealDetails>'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `UnofficialFreeeSdk::DealResponseDealRenews` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `UnofficialFreeeSdk::DealResponseDealRenews`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'renew_target_id')
        self.renew_target_id = attributes[:'renew_target_id']
      end

      if attributes.key?(:'renew_target_type')
        self.renew_target_type = attributes[:'renew_target_type']
      end
    ...
    def list_invalid_properties
      ...
      if @renew_target_id.nil?
        invalid_properties.push('invalid value for "renew_target_id", renew_target_id cannot be nil.')
      end

      if @renew_target_id > 999999999999
        invalid_properties.push('invalid value for "renew_target_id", must be smaller than or equal to 999999999999.')
      end

      if @renew_target_id < 1
        invalid_properties.push('invalid value for "renew_target_id", must be greater than or equal to 1.')
      end

      if @renew_target_type.nil?
        invalid_properties.push('invalid value for "renew_target_type", renew_target_type cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @renew_target_id.nil?
      return false if @renew_target_id > 999999999999
      return false if @renew_target_id < 1
      return false if @renew_target_type.nil?
      renew_target_type_validator = EnumAttributeValidator.new('String', ["detail", "accrual", "renew"])
      return false unless renew_target_type_validator.valid?(@renew_target_type)
    ...
    # Custom attribute writer method with validation
    # @param [Object] renew_target_id Value to be assigned
    def renew_target_id=(renew_target_id)
      if renew_target_id.nil?
        fail ArgumentError, 'renew_target_id cannot be nil'
      end

      if renew_target_id > 999999999999
        fail ArgumentError, 'invalid value for "renew_target_id", must be smaller than or equal to 999999999999.'
      end

      if renew_target_id < 1
        fail ArgumentError, 'invalid value for "renew_target_id", must be greater than or equal to 1.'
      end
    ...
    # @param [Object] renew_target_type Object to be assigned
    def renew_target_type=(renew_target_type)
      validator = EnumAttributeValidator.new('String', ["detail", "accrual", "renew"])
      unless validator.valid?(renew_target_type)
        fail ArgumentError, "invalid value for \"renew_target_type\", must be one of #{validator.allowable_values}."
      end
      @renew_target_type = renew_target_type
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          renew_target_id == o.renew_target_id &&
          renew_target_type == o.renew_target_type &&
          details == o.details
    end
    ...
    def hash
      [id, update_date, renew_target_id, renew_target_type, details].hash
    end
